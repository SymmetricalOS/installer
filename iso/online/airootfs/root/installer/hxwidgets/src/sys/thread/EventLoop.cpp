...
HX_LOCAL_STACK_FRAME(_hx_pos_dec05f81178ee6ce_42_repeat,"sys.thread.EventLoop","repeat",0xe060da0e,"sys.thread.EventLoop.repeat","/usr/share/haxe/std/sys/thread/EventLoop.hx",42,0x36352808)
HX_LOCAL_STACK_FRAME(_hx_pos_dec05f81178ee6ce_86_cancel,"sys.thread.EventLoop","cancel",0x9218302d,"sys.thread.EventLoop.cancel","/usr/share/haxe/std/sys/thread/EventLoop.hx",86,0x36352808)
...
bool EventLoop_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::_EventLoop::RegularEvent EventLoop_obj::repeat( ::Dynamic event,int intervalMs){
            	HX_GC_STACKFRAME(&_hx_pos_dec05f81178ee6ce_42_repeat)
...
void EventLoop_obj::cancel( ::sys::thread::_EventLoop::RegularEvent eventHandler){
            	HX_STACKFRAME(&_hx_pos_dec05f81178ee6ce_86_cancel)
