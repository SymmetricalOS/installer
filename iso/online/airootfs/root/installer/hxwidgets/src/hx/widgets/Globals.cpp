...
HXLINE(  35)		::cpp::Pointer<  wxString > cwd = ::cpp::Pointer_obj::fromRaw((new wxString(s.utf8_str())));
...
HXLINE(  40)		::cpp::Pointer<  wxString > wxCmd = ::cpp::Pointer_obj::fromRaw((new wxString(cmd.utf8_str())));
