...
HXLINE( 429)					{
HXLINE( 429)						 ::haxe::ui::core::Component _this1 = _gthis->_component;
HXDLIN( 429)						bool _hx_tmp1;
HXDLIN( 429)						if (::hx::IsNotNull( _this1->_layout )) {
HXLINE( 429)							_hx_tmp1 = (_this1->_layoutLocked == true);
            						}
            						else {
HXLINE( 429)							_hx_tmp1 = true;
            						}
HXDLIN( 429)						if (!(_hx_tmp1)) {
HXLINE( 429)							_this1->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            						}
            					}
            				}
...
HXLINE( 436)			 ::haxe::ui::core::Component _this1 = this->_component;
HXDLIN( 436)			bool _hx_tmp1;
HXDLIN( 436)			if (::hx::IsNotNull( _this1->_layout )) {
HXLINE( 436)				_hx_tmp1 = (_this1->_layoutLocked == true);
            			}
            			else {
HXLINE( 436)				_hx_tmp1 = true;
            			}
HXDLIN( 436)			if (!(_hx_tmp1)) {
HXLINE( 436)				_this1->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            			}
            		}
