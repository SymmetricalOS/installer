...
HX_DEFINE_STACK_FRAME(_hx_pos_3bc9dc675deae08b_106_new,"haxe.ui.components._Range.RangeMax","new",0x35cd8643,"haxe.ui.components._Range.RangeMax.new","haxe/ui/components/Range.hx",106,0x313cba28)
HX_LOCAL_STACK_FRAME(_hx_pos_3bc9dc675deae08b_107_validateData,"haxe.ui.components._Range.RangeMax","validateData",0x92934b9d,"haxe.ui.components._Range.RangeMax.validateData","haxe/ui/components/Range.hx",107,0x313cba28)
namespace haxe{
namespace ui{
...
void RangeMax_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_3bc9dc675deae08b_106_new)
...
void RangeMax_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_3bc9dc675deae08b_107_validateData)
HXLINE( 108)		 ::haxe::ui::components::Range range = ::hx::TCast<  ::haxe::ui::components::Range >::cast(this->_component);
HXLINE( 109)		range->set_max(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value));
HXLINE( 110)		Float _hx_tmp = range->get_end();
HXDLIN( 110)		if (::hx::IsGreater( _hx_tmp,range->get_max() )) {
HXLINE( 111)			range->set_end(( (Float)(range->get_max()) ));
            		}
HXLINE( 113)		{
HXLINE( 113)			 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 113)			bool _hx_tmp1;
HXDLIN( 113)			if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 113)				_hx_tmp1 = (_this->_layoutLocked == true);
            			}
            			else {
HXLINE( 113)				_hx_tmp1 = true;
            			}
HXDLIN( 113)			if (!(_hx_tmp1)) {
HXLINE( 113)				_this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            			}
            		}
            	}
