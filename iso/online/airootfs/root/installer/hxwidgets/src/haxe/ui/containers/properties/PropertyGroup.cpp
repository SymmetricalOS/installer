...
HX_LOCAL_STACK_FRAME(_hx_pos_c729f952cb4a8f3f_193_registerComposite,"haxe.ui.containers.properties.PropertyGroup","registerComposite",0x17b4c84f,"haxe.ui.containers.properties.PropertyGroup.registerComposite","haxe/ui/macros/Macros.hx",193,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_c729f952cb4a8f3f_522_registerBehaviours,"haxe.ui.containers.properties.PropertyGroup","registerBehaviours",0x29798a4e,"haxe.ui.containers.properties.PropertyGroup.registerBehaviours","haxe/ui/macros/Macros.hx",522,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_397938b558432c5e_651_cloneComponent,"haxe.ui.containers.properties.PropertyGroup","cloneComponent",0x0d5f2d95,"haxe.ui.containers.properties.PropertyGroup.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",651,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_c729f952cb4a8f3f_493_self,"haxe.ui.containers.properties.PropertyGroup","self",0x56863b41,"haxe.ui.containers.properties.PropertyGroup.self","haxe/ui/macros/Macros.hx",493,0x27866361)
namespace haxe{
namespace ui{
...
void PropertyGroup_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_c729f952cb4a8f3f_193_registerComposite)
HXLINE( 194)		this->super::registerComposite();
HXLINE( 202)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGroup::Events >();
HXLINE( 206)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGroup::Builder >();
            	}


void PropertyGroup_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_c729f952cb4a8f3f_522_registerBehaviours)
HXLINE( 523)		this->super::registerBehaviours();
HXLINE( 632)		this->behaviours->_hx_register(HX_("text",ad,cc,f9,4c),::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGroup::TextBehaviour >(),null());
            	}


 ::haxe::ui::core::ComponentContainer PropertyGroup_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_397938b558432c5e_651_cloneComponent)
HXLINE( 441)		 ::haxe::ui::containers::properties::PropertyGroup c = ( ( ::haxe::ui::containers::properties::PropertyGroup)(this->super::cloneComponent()) );
HXLINE( 456)		{
...
HXLINE( 465)		return c;
 ...
 ::haxe::ui::core::ComponentContainer PropertyGroup_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_c729f952cb4a8f3f_493_self)
HXDLIN( 493)		return  ::haxe::ui::containers::properties::PropertyGroup_obj::__alloc( HX_CTX );
            	}
