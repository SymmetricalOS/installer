...
HX_DEFINE_STACK_FRAME(_hx_pos_030edafd208e7fa8_249_new,"haxe.ui.components.RangeBuilder","new",0xe99a8f76,"haxe.ui.components.RangeBuilder.new","haxe/ui/components/Range.hx",249,0x313cba28)
HX_LOCAL_STACK_FRAME(_hx_pos_030edafd208e7fa8_254_create,"haxe.ui.components.RangeBuilder","create",0x70d4b9a6,"haxe.ui.components.RangeBuilder.create","haxe/ui/components/Range.hx",254,0x313cba28)
HX_LOCAL_STACK_FRAME(_hx_pos_030edafd208e7fa8_264_showWarning,"haxe.ui.components.RangeBuilder","showWarning",0xc3c43bf5,"haxe.ui.components.RangeBuilder.showWarning","haxe/ui/components/Range.hx",264,0x313cba28)
namespace haxe{
namespace ui{
namespace components{

void RangeBuilder_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_030edafd208e7fa8_249_new)
HXLINE( 250)		super::__construct(component);
HXLINE( 251)		this->showWarning();
            	}
...
void RangeBuilder_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_030edafd208e7fa8_254_create)
HXLINE( 255)		this->super::create();
HXLINE( 256)		if (::hx::IsNull( this->_component->findComponent(HX_("${_component.cssName}-value",ac,ff,7a,bc),null(),null(),null()) )) {
HXLINE( 257)			 ::haxe::ui::core::Component v =  ::haxe::ui::core::Component_obj::__alloc( HX_CTX );
HXLINE( 258)			v->set_id(((HX_("",00,00,00,00) + this->_component->get_cssName()) + HX_("-value",24,bc,c7,2f)));
HXLINE( 259)			v->addClass(((HX_("",00,00,00,00) + this->_component->get_cssName()) + HX_("-value",24,bc,c7,2f)),false,null());
HXLINE( 260)			this->_component->addComponent(v);
            		}
            	}


void RangeBuilder_obj::showWarning(){
            	HX_STACKFRAME(&_hx_pos_030edafd208e7fa8_264_showWarning)
HXLINE( 265)		::String name = ( (::String)(this->_component->get_className().split(HX_(".",2e,00,00,00))->pop()) );
HXLINE( 266)		::haxe::Log_obj::trace(((((((HX_("WARNING: trying to create an instance of '",ac,bf,13,06) + name) + HX_("' directly, use either 'Horizontal",4c,3c,5e,4a)) + name) + HX_("' or 'Vertical",19,22,61,b5)) + name) + HX_("'",27,00,00,00)),::hx::SourceInfo(HX_("haxe/ui/components/Range.hx",28,ba,3c,31),266,HX_("haxe.ui.components.RangeBuilder",84,5c,9c,6e),HX_("showWarning",df,76,67,e6)));
            	}
