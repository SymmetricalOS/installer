...
HX_DEFINE_STACK_FRAME(_hx_pos_69fd336de6798f19_717_new,"haxe.ui.containers._TableView.SelectedIndexBehaviour","new",0xc3543f48,"haxe.ui.containers._TableView.SelectedIndexBehaviour.new","haxe/ui/containers/TableView.hx",717,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_69fd336de6798f19_718_get,"haxe.ui.containers._TableView.SelectedIndexBehaviour","get",0xc34eef7e,"haxe.ui.containers._TableView.SelectedIndexBehaviour.get","haxe/ui/containers/TableView.hx",718,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_69fd336de6798f19_724_set,"haxe.ui.containers._TableView.SelectedIndexBehaviour","set",0xc3580a8a,"haxe.ui.containers._TableView.SelectedIndexBehaviour.set","haxe/ui/containers/TableView.hx",724,0x8a42a716)
namespace haxe{
namespace ui{
...
void SelectedIndexBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_69fd336de6798f19_717_new)
...
bool SelectedIndexBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType SelectedIndexBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_69fd336de6798f19_718_get)
...
HXDLIN( 721)		if (::hx::IsNotNull( selectedIndices )) {
HXLINE( 721)			_hx_tmp = (selectedIndices->length > 0);
            		}
            		else {
HXLINE( 721)			_hx_tmp = false;
            		}
HXDLIN( 721)		if (_hx_tmp) {
HXLINE( 721)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(selectedIndices->__get((selectedIndices->length - 1)));
            		}
            		else {
HXLINE( 721)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(-1);
            		}
...
void SelectedIndexBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_69fd336de6798f19_724_set)
HXLINE( 725)		 ::haxe::ui::containers::TableView tableView = ::hx::TCast<  ::haxe::ui::containers::TableView >::cast(this->_component);
HXLINE( 726)		::Array< int > _hx_tmp;
HXDLIN( 726)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::neq(value,::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(-1))) {
HXLINE( 726)			_hx_tmp = ::Array_obj< int >::__new(1)->init(0,::haxe::ui::util::_Variant::Variant_Impl__obj::toInt(value));
            		}
            		else {
HXLINE( 726)			_hx_tmp = null();
            		}
HXDLIN( 726)		tableView->set_selectedIndices(_hx_tmp);
            	}
