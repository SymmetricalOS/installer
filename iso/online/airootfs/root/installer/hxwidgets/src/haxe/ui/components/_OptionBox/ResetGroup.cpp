...
HX_DEFINE_STACK_FRAME(_hx_pos_8816803964aceebb_91_new,"haxe.ui.components._OptionBox.ResetGroup","new",0x1f62e013,"haxe.ui.components._OptionBox.ResetGroup.new","haxe/ui/components/OptionBox.hx",91,0x8f34a36f)
HX_LOCAL_STACK_FRAME(_hx_pos_8816803964aceebb_92_call,"haxe.ui.components._OptionBox.ResetGroup","call",0x4fd8c58b,"haxe.ui.components._OptionBox.ResetGroup.call","haxe/ui/components/OptionBox.hx",92,0x8f34a36f)
namespace haxe{
namespace ui{
...
void ResetGroup_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_8816803964aceebb_91_new)
...
bool ResetGroup_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType ResetGroup_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_8816803964aceebb_92_call)
HXLINE(  93)		 ::haxe::ui::components::OptionBox optionbox = ::hx::TCast<  ::haxe::ui::components::OptionBox >::cast(this->_component);
HXLINE(  94)		 ::haxe::ui::components::OptionBoxGroups _hx_tmp = ::haxe::ui::components::OptionBoxGroups_obj::get_instance();
HXDLIN(  94)		_hx_tmp->reset(optionbox->get_componentGroup());
