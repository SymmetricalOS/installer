...
HX_LOCAL_STACK_FRAME(_hx_pos_b1c112e181ae1c65_523_registerBehaviours,"haxe.ui.components._Switch.SwitchButtonSub","registerBehaviours",0x62d5bfae,"haxe.ui.components._Switch.SwitchButtonSub.registerBehaviours","haxe/ui/macros/Macros.hx",523,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_508e58cc2a7fb5a3_651_cloneComponent,"haxe.ui.components._Switch.SwitchButtonSub","cloneComponent",0xa85d32f5,"haxe.ui.components._Switch.SwitchButtonSub.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",651,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c112e181ae1c65_493_self,"haxe.ui.components._Switch.SwitchButtonSub","self",0x6b49c8a1,"haxe.ui.components._Switch.SwitchButtonSub.self","haxe/ui/macros/Macros.hx",493,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c112e181ae1c65_193_registerComposite,"haxe.ui.components._Switch.SwitchButtonSub","registerComposite",0x7cfc5eef,"haxe.ui.components._Switch.SwitchButtonSub.registerComposite","haxe/ui/macros/Macros.hx",193,0x27866361)
namespace haxe{
namespace ui{
...
HXDLIN( 188)		if (this->_componentReady) {
...
HXDLIN( 201)		if (this->_componentReady) {
...
void SwitchButtonSub_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_b1c112e181ae1c65_523_registerBehaviours)
HXDLIN( 523)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer SwitchButtonSub_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_508e58cc2a7fb5a3_651_cloneComponent)
HXLINE( 441)		 ::haxe::ui::components::_Switch::SwitchButtonSub c = ( ( ::haxe::ui::components::_Switch::SwitchButtonSub)(this->super::cloneComponent()) );
...
HXLINE( 465)		return c;
 ...
 ::haxe::ui::core::ComponentContainer SwitchButtonSub_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_b1c112e181ae1c65_493_self)
HXDLIN( 493)		return  ::haxe::ui::components::_Switch::SwitchButtonSub_obj::__alloc( HX_CTX );
            	}


void SwitchButtonSub_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_b1c112e181ae1c65_193_registerComposite)
HXLINE( 194)		this->super::registerComposite();
HXLINE( 210)		this->_defaultLayoutClass = ::hx::ClassOf< ::haxe::ui::components::_Switch::SwitchButtonLayout >();
            	}
