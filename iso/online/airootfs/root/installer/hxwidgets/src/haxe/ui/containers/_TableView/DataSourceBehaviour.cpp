...
HX_DEFINE_STACK_FRAME(_hx_pos_39fbe7471cd72fbf_686_new,"haxe.ui.containers._TableView.DataSourceBehaviour","new",0x0f08d2fa,"haxe.ui.containers._TableView.DataSourceBehaviour.new","haxe/ui/containers/TableView.hx",686,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_39fbe7471cd72fbf_688_set,"haxe.ui.containers._TableView.DataSourceBehaviour","set",0x0f0c9e3c,"haxe.ui.containers._TableView.DataSourceBehaviour.set","haxe/ui/containers/TableView.hx",688,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_39fbe7471cd72fbf_693_set,"haxe.ui.containers._TableView.DataSourceBehaviour","set",0x0f0c9e3c,"haxe.ui.containers._TableView.DataSourceBehaviour.set","haxe/ui/containers/TableView.hx",693,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_39fbe7471cd72fbf_707_get,"haxe.ui.containers._TableView.DataSourceBehaviour","get",0x0f038330,"haxe.ui.containers._TableView.DataSourceBehaviour.get","haxe/ui/containers/TableView.hx",707,0x8a42a716)
namespace haxe{
namespace ui{
...
void DataSourceBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_39fbe7471cd72fbf_686_new)
HXLINE( 687)		this->_firstPass = true;
HXLINE( 686)		super::__construct(component);
            	}
...
void DataSourceBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_GC_STACKFRAME(&_hx_pos_39fbe7471cd72fbf_688_set)
HXDLIN( 688)		 ::haxe::ui::containers::_TableView::DataSourceBehaviour _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 689)		this->super::set(value);
HXLINE( 690)		 ::haxe::ui::data::DataSource dataSource = ::haxe::ui::util::_Variant::Variant_Impl__obj::toDataSource(this->_value);
HXLINE( 691)		if (::hx::IsNotNull( dataSource )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::haxe::ui::containers::_TableView::DataSourceBehaviour,_gthis) HXARGC(0)
            			void _hx_run(){
            				HX_GC_STACKFRAME(&_hx_pos_39fbe7471cd72fbf_693_set)
HXLINE( 694)				{
HXLINE( 694)					 ::haxe::ui::core::Component _this = _gthis->_component;
HXDLIN( 694)					bool _hx_tmp;
HXDLIN( 694)					if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 694)						_hx_tmp = (_this->_layoutLocked == true);
            					}
            					else {
HXLINE( 694)						_hx_tmp = true;
            					}
HXDLIN( 694)					if (!(_hx_tmp)) {
HXLINE( 694)						_this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            					}
            				}
HXLINE( 695)				if ((_gthis->_firstPass == true)) {
HXLINE( 697)					_gthis->_firstPass = false;
HXLINE( 698)					{
HXLINE( 698)						 ::haxe::ui::core::Component _this1 = _gthis->_component;
HXDLIN( 698)						bool _hx_tmp1;
HXDLIN( 698)						if (::hx::IsNotNull( _this1->_layout )) {
HXLINE( 698)							_hx_tmp1 = (_this1->_layoutLocked == true);
            						}
            						else {
HXLINE( 698)							_hx_tmp1 = true;
            						}
HXDLIN( 698)						if (!(_hx_tmp1)) {
HXLINE( 698)							_this1->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            						}
            					}
            				}
            			}
...
HXLINE( 692)			dataSource->transformer =  ::haxe::ui::data::transformation::NativeTypeTransformer_obj::__alloc( HX_CTX );
HXLINE( 693)			dataSource->onDataSourceChange =  ::Dynamic(new _hx_Closure_0(_gthis));
HXLINE( 701)			{
HXLINE( 701)				 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 701)				bool _hx_tmp;
HXDLIN( 701)				if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 701)					_hx_tmp = (_this->_layoutLocked == true);
            				}
            				else {
HXLINE( 701)					_hx_tmp = true;
            				}
HXDLIN( 701)				if (!(_hx_tmp)) {
HXLINE( 701)					_this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            				}
            			}
            		}
            		else {
HXLINE( 703)			 ::haxe::ui::core::Component _this1 = this->_component;
HXDLIN( 703)			bool _hx_tmp1;
HXDLIN( 703)			if (::hx::IsNotNull( _this1->_layout )) {
HXLINE( 703)				_hx_tmp1 = (_this1->_layoutLocked == true);
            			}
            			else {
HXLINE( 703)				_hx_tmp1 = true;
            			}
HXDLIN( 703)			if (!(_hx_tmp1)) {
HXLINE( 703)				_this1->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            			}
            		}
            	}
 ...
 ::haxe::ui::util::VariantType DataSourceBehaviour_obj::get(){
            	HX_GC_STACKFRAME(&_hx_pos_39fbe7471cd72fbf_707_get)
HXLINE( 708)		bool _hx_tmp;
HXDLIN( 708)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 708)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
HXLINE( 708)			_hx_tmp = true;
            		}
HXDLIN( 708)		if (_hx_tmp) {
HXLINE( 709)			this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromDataSource( ::haxe::ui::data::ArrayDataSource_obj::__alloc( HX_CTX ,null()));
HXLINE( 710)			this->set(this->_value);
            		}
HXLINE( 712)		return this->_value;
            	}
