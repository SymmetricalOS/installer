...
HXLINE( 227)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(( (Float)(contents->get_width()) ));
            	}
...
HXLINE( 234)			contents->set_width(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(value));
            		}
            	}
