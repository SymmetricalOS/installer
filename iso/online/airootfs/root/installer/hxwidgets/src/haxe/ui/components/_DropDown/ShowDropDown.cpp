...
HX_DEFINE_STACK_FRAME(_hx_pos_f72592ce4ca3422c_91_new,"haxe.ui.components._DropDown.ShowDropDown","new",0xf17924e4,"haxe.ui.components._DropDown.ShowDropDown.new","haxe/ui/components/DropDown.hx",91,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_f72592ce4ca3422c_92_call,"haxe.ui.components._DropDown.ShowDropDown","call",0x513eb79a,"haxe.ui.components._DropDown.ShowDropDown.call","haxe/ui/components/DropDown.hx",92,0x145b8c86)
namespace haxe{
namespace ui{
...
void ShowDropDown_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_f72592ce4ca3422c_91_new)
...
bool ShowDropDown_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType ShowDropDown_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_f72592ce4ca3422c_92_call)
HXLINE(  93)		 ::haxe::ui::components::DropDownEvents events = ::hx::TCast<  ::haxe::ui::components::DropDownEvents >::cast(this->_component->_internalEvents);
HXLINE(  94)		events->showDropDown();
