...
HX_DEFINE_STACK_FRAME(_hx_pos_934ba5857642ff2e_191_new,"haxe.ui.components._TextField.MaxCharsBehaviour","new",0x4ceb12bc,"haxe.ui.components._TextField.MaxCharsBehaviour.new","haxe/ui/components/TextField.hx",191,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_934ba5857642ff2e_192_validateData,"haxe.ui.components._TextField.MaxCharsBehaviour","validateData",0xcc96e804,"haxe.ui.components._TextField.MaxCharsBehaviour.validateData","haxe/ui/components/TextField.hx",192,0x9dfe9498)
namespace haxe{
namespace ui{
...
void MaxCharsBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_934ba5857642ff2e_191_new)
HXDLIN( 191)		super::__construct(component);
            	}
...
void MaxCharsBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_934ba5857642ff2e_192_validateData)
HXLINE( 193)		 ::haxe::ui::components::TextField textfield = ::hx::TCast<  ::haxe::ui::components::TextField >::cast(this->_component);
HXLINE( 194)		::haxe::ui::components::_TextField::TextFieldHelper_obj::validateText(textfield,textfield->get_text());
            	}
