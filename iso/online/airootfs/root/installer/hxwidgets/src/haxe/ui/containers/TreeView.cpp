...
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_658_addNode,"haxe.ui.containers.TreeView","addNode",0x0a95c662,"haxe.ui.containers.TreeView.addNode","haxe/ui/macros/Macros.hx",658,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_658_removeNode,"haxe.ui.containers.TreeView","removeNode",0x69855827,"haxe.ui.containers.TreeView.removeNode","haxe/ui/macros/Macros.hx",658,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_650_clearNodes,"haxe.ui.containers.TreeView","clearNodes",0x18250b25,"haxe.ui.containers.TreeView.clearNodes","haxe/ui/macros/Macros.hx",650,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_661_getNodesInternal,"haxe.ui.containers.TreeView","getNodesInternal",0xdf8f7899,"haxe.ui.containers.TreeView.getNodesInternal","haxe/ui/macros/Macros.hx",661,0x27866361)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_193_registerComposite,"haxe.ui.containers.TreeView","registerComposite",0x9c243b83,"haxe.ui.containers.TreeView.registerComposite","haxe/ui/macros/Macros.hx",193,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_522_registerBehaviours,"haxe.ui.containers.TreeView","registerBehaviours",0x868ee49a,"haxe.ui.containers.TreeView.registerBehaviours","haxe/ui/macros/Macros.hx",522,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_559_get_selectedNode,"haxe.ui.containers.TreeView","get_selectedNode",0xe01df107,"haxe.ui.containers.TreeView.get_selectedNode","haxe/ui/macros/Macros.hx",559,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_613_set_selectedNode,"haxe.ui.containers.TreeView","set_selectedNode",0x365fde7b,"haxe.ui.containers.TreeView.set_selectedNode","haxe/ui/macros/Macros.hx",613,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_44ba5fd4ba31efac_651_cloneComponent,"haxe.ui.containers.TreeView","cloneComponent",0x650e71e1,"haxe.ui.containers.TreeView.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",651,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_493_self,"haxe.ui.containers.TreeView","self",0xc113688d,"haxe.ui.containers.TreeView.self","haxe/ui/macros/Macros.hx",493,0x27866361)
namespace haxe{
namespace ui{
...
void *TreeView_obj::_hx_getInterface(int inHash) {
 ...
 ::haxe::ui::containers::TreeViewNode TreeView_obj::addNode( ::Dynamic data){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_658_addNode)
...
HX_DEFINE_DYNAMIC_FUNC1(TreeView_obj,addNode,return )
 ...
 ::haxe::ui::containers::TreeViewNode TreeView_obj::removeNode( ::haxe::ui::containers::TreeViewNode node){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_658_removeNode)
...
void TreeView_obj::clearNodes(){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_650_clearNodes)
...
::Array< ::Dynamic> TreeView_obj::getNodesInternal(){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_661_getNodesInternal)
...
void TreeView_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_193_registerComposite)
HXLINE( 194)		this->super::registerComposite();
HXLINE( 202)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::containers::_TreeView::TreeViewEvents >();
HXLINE( 206)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::_TreeView::TreeViewBuilder >();
            	}


void TreeView_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_522_registerBehaviours)
HXLINE( 523)		this->super::registerBehaviours();
HXLINE( 632)		this->behaviours->_hx_register(HX_("selectedNode",fd,29,a4,d9),::hx::ClassOf< ::haxe::ui::containers::_TreeView::SelectedNode >(),null());
HXLINE( 671)		this->behaviours->_hx_register(HX_("addNode",c3,4c,47,85),::hx::ClassOf< ::haxe::ui::containers::_TreeView::AddNode >(),null());
HXDLIN( 671)		this->behaviours->_hx_register(HX_("removeNode",66,44,29,c6),::hx::ClassOf< ::haxe::ui::containers::_TreeView::RemoveNode >(),null());
HXDLIN( 671)		this->behaviours->_hx_register(HX_("clearNodes",64,f7,c8,74),::hx::ClassOf< ::haxe::ui::containers::_TreeView::ClearNodes >(),null());
HXDLIN( 671)		this->behaviours->_hx_register(HX_("getNodesInternal",18,9e,b4,dd),::hx::ClassOf< ::haxe::ui::containers::_TreeView::GetNodesInternal >(),null());
            	}


 ::haxe::ui::containers::TreeViewNode TreeView_obj::get_selectedNode(){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_559_get_selectedNode)
HXLINE( 560)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 561)			return null();
            		}
HXLINE( 563)		return ( ( ::haxe::ui::containers::TreeViewNode)(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->behaviours->get(HX_("selectedNode",fd,29,a4,d9)))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TreeView_obj,get_selectedNode,return )
 ...
 ::haxe::ui::containers::TreeViewNode TreeView_obj::set_selectedNode( ::haxe::ui::containers::TreeViewNode value){
            	HX_GC_STACKFRAME(&_hx_pos_e29e92d3fff25226_613_set_selectedNode)
...
HXDLIN( 617)		_hx_tmp->set(HX_("selectedNode",fd,29,a4,d9),::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(value));
HXLINE( 618)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("propertychange",85,47,b1,35),null(),HX_("selectedNode",fd,29,a4,d9)));
...
HX_DEFINE_DYNAMIC_FUNC1(TreeView_obj,set_selectedNode,return )
 ...
 ::haxe::ui::core::ComponentContainer TreeView_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_44ba5fd4ba31efac_651_cloneComponent)
HXLINE( 441)		 ::haxe::ui::containers::TreeView c = ( ( ::haxe::ui::containers::TreeView)(this->super::cloneComponent()) );
HXLINE( 456)		{
...
HXLINE( 465)		return c;
 ...
 ::haxe::ui::core::ComponentContainer TreeView_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_e29e92d3fff25226_493_self)
HXDLIN( 493)		return  ::haxe::ui::containers::TreeView_obj::__alloc( HX_CTX );
            	}
