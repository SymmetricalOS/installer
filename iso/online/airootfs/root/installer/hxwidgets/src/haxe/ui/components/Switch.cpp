...
HX_LOCAL_STACK_FRAME(_hx_pos_f1dc642d6902d9d2_193_registerComposite,"haxe.ui.components.Switch","registerComposite",0xf6f7a6d0,"haxe.ui.components.Switch.registerComposite","haxe/ui/macros/Macros.hx",193,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_f1dc642d6902d9d2_522_registerBehaviours,"haxe.ui.components.Switch","registerBehaviours",0xa4b95cad,"haxe.ui.components.Switch.registerBehaviours","haxe/ui/macros/Macros.hx",522,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_f1dc642d6902d9d2_566_get_selected,"haxe.ui.components.Switch","get_selected",0x49fe7c38,"haxe.ui.components.Switch.get_selected","haxe/ui/macros/Macros.hx",566,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_f1dc642d6902d9d2_583_set_selected,"haxe.ui.components.Switch","set_selected",0x5ef79fac,"haxe.ui.components.Switch.set_selected","haxe/ui/macros/Macros.hx",583,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_f1dc642d6902d9d2_566_get_textOn,"haxe.ui.components.Switch","get_textOn",0x64b687c9,"haxe.ui.components.Switch.get_textOn","haxe/ui/macros/Macros.hx",566,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_f1dc642d6902d9d2_599_set_textOn,"haxe.ui.components.Switch","set_textOn",0x6834263d,"haxe.ui.components.Switch.set_textOn","haxe/ui/macros/Macros.hx",599,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_f1dc642d6902d9d2_566_get_textOff,"haxe.ui.components.Switch","get_textOff",0xbb004185,"haxe.ui.components.Switch.get_textOff","haxe/ui/macros/Macros.hx",566,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_f1dc642d6902d9d2_599_set_textOff,"haxe.ui.components.Switch","set_textOff",0xc56d4891,"haxe.ui.components.Switch.set_textOff","haxe/ui/macros/Macros.hx",599,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_f1dc642d6902d9d2_689_get_value,"haxe.ui.components.Switch","get_value",0xf0ea1174,"haxe.ui.components.Switch.get_value","haxe/ui/macros/Macros.hx",689,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_f1dc642d6902d9d2_739_set_value,"haxe.ui.components.Switch","set_value",0xd43afd80,"haxe.ui.components.Switch.set_value","haxe/ui/macros/Macros.hx",739,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_c9b63221bf3230fc_651_cloneComponent,"haxe.ui.components.Switch","cloneComponent",0x8d50a474,"haxe.ui.components.Switch.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",651,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_f1dc642d6902d9d2_493_self,"haxe.ui.components.Switch","self",0xee8c3560,"haxe.ui.components.Switch.self","haxe/ui/macros/Macros.hx",493,0x27866361)
namespace haxe{
namespace ui{
...
void Switch_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_f1dc642d6902d9d2_193_registerComposite)
HXLINE( 194)		this->super::registerComposite();
HXLINE( 206)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::components::_Switch::Builder >();
HXLINE( 210)		this->_defaultLayoutClass = ::hx::ClassOf< ::haxe::ui::layouts::HorizontalLayout >();
            	}


void Switch_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_f1dc642d6902d9d2_522_registerBehaviours)
HXLINE( 523)		this->super::registerBehaviours();
HXLINE( 632)		this->behaviours->_hx_register(HX_("selected",5b,2a,6d,b1),::hx::ClassOf< ::haxe::ui::components::_Switch::SelectedBehaviour >(),null());
HXDLIN( 632)		this->behaviours->_hx_register(HX_("text",ad,cc,f9,4c),::hx::ClassOf< ::haxe::ui::components::_Switch::TextBehaviour >(),null());
HXDLIN( 632)		this->behaviours->_hx_register(HX_("textOn",2c,57,88,d8),::hx::ClassOf< ::haxe::ui::behaviours::DefaultBehaviour >(),null());
HXDLIN( 632)		this->behaviours->_hx_register(HX_("textOff",c2,e8,c3,9e),::hx::ClassOf< ::haxe::ui::behaviours::DefaultBehaviour >(),null());
            	}


bool Switch_obj::get_selected(){
            	HX_STACKFRAME(&_hx_pos_f1dc642d6902d9d2_566_get_selected)
...
bool Switch_obj::set_selected(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_f1dc642d6902d9d2_583_set_selected)
...
::String Switch_obj::get_textOn(){
            	HX_STACKFRAME(&_hx_pos_f1dc642d6902d9d2_566_get_textOn)
HXLINE( 567)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 568)			return null();
            		}
HXLINE( 570)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->behaviours->get(HX_("textOn",2c,57,88,d8)));
            	}
...
::String Switch_obj::set_textOn(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_f1dc642d6902d9d2_599_set_textOn)
HXLINE( 600)		{
...
HXLINE( 603)						::haxe::ui::locale::LocaleManager_obj::get_instance()->registerComponent(( ( ::haxe::ui::core::Component)(::hx::ObjectPtr<OBJ_>(this)) ),HX_("textOn",2c,57,88,d8),null(),value,null());
...
HXDLIN( 608)		_hx_tmp2->set(HX_("textOn",2c,57,88,d8),::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(value));
HXLINE( 609)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("propertychange",85,47,b1,35),null(),HX_("textOn",2c,57,88,d8)));
...
::String Switch_obj::get_textOff(){
            	HX_STACKFRAME(&_hx_pos_f1dc642d6902d9d2_566_get_textOff)
HXLINE( 567)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 568)			return null();
            		}
HXLINE( 570)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->behaviours->get(HX_("textOff",c2,e8,c3,9e)));
            	}
...
::String Switch_obj::set_textOff(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_f1dc642d6902d9d2_599_set_textOff)
HXLINE( 600)		{
HXLINE( 600)			 ::ValueType _g = ::Type_obj::_hx_typeof(value);
HXDLIN( 600)			if ((_g->_hx_getIndex() == 6)) {
HXLINE( 601)				if (::hx::IsPointerEq( _g->_hx_getObject(0).StaticCast< ::hx::Class >(),::hx::ClassOf< ::String >() )) {
...
HXDLIN( 602)					if (_hx_tmp) {
HXLINE( 603)						::haxe::ui::locale::LocaleManager_obj::get_instance()->registerComponent(( ( ::haxe::ui::core::Component)(::hx::ObjectPtr<OBJ_>(this)) ),HX_("textOff",c2,e8,c3,9e),null(),value,null());
HXLINE( 604)						return value;
            					}
            				}
            			}
...
HXLINE( 608)		 ::haxe::ui::behaviours::Behaviours _hx_tmp2 = this->behaviours;
HXDLIN( 608)		_hx_tmp2->set(HX_("textOff",c2,e8,c3,9e),::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(value));
HXLINE( 609)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("propertychange",85,47,b1,35),null(),HX_("textOff",c2,e8,c3,9e)));
HXLINE( 610)		return value;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Switch_obj,set_textOff,return )
 ...
 ::Dynamic Switch_obj::get_value(){
            	HX_STACKFRAME(&_hx_pos_f1dc642d6902d9d2_689_get_value)
HXDLIN( 689)		return this->get_selected();
            	}


 ::Dynamic Switch_obj::set_value( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_f1dc642d6902d9d2_739_set_value)
HXLINE( 740)		{
...
HXLINE( 752)		return value;
 ...
 ::haxe::ui::core::ComponentContainer Switch_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_c9b63221bf3230fc_651_cloneComponent)
HXLINE( 441)		 ::haxe::ui::components::Switch c = ( ( ::haxe::ui::components::Switch)(this->super::cloneComponent()) );
HXLINE( 452)		c->set_selected(this->get_selected());
HXLINE( 450)		if (::hx::IsNotNull( this->get_textOn() )) {
HXLINE( 450)			c->set_textOn(this->get_textOn());
            		}
HXDLIN( 450)		if (::hx::IsNotNull( this->get_textOff() )) {
HXLINE( 450)			c->set_textOff(this->get_textOff());
            		}
HXLINE( 456)		{
...
HXLINE( 465)		return c;
 ...
 ::haxe::ui::core::ComponentContainer Switch_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_f1dc642d6902d9d2_493_self)
HXDLIN( 493)		return  ::haxe::ui::components::Switch_obj::__alloc( HX_CTX );
            	}
