...
HX_LOCAL_STACK_FRAME(_hx_pos_d81e3849569e5e7d_193_registerComposite,"haxe.ui.containers.Header","registerComposite",0x57f15a2d,"haxe.ui.containers.Header.registerComposite","haxe/ui/macros/Macros.hx",193,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_d81e3849569e5e7d_523_registerBehaviours,"haxe.ui.containers.Header","registerBehaviours",0x1e3c9ab0,"haxe.ui.containers.Header.registerBehaviours","haxe/ui/macros/Macros.hx",523,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_68ace50d51adcb50_651_cloneComponent,"haxe.ui.containers.Header","cloneComponent",0x5db5e4f7,"haxe.ui.containers.Header.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",651,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_d81e3849569e5e7d_493_self,"haxe.ui.containers.Header","self",0x30a84423,"haxe.ui.containers.Header.self","haxe/ui/macros/Macros.hx",493,0x27866361)
namespace haxe{
namespace ui{
...
void Header_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_d81e3849569e5e7d_193_registerComposite)
HXLINE( 194)		this->super::registerComposite();
HXLINE( 210)		this->_defaultLayoutClass = ::hx::ClassOf< ::haxe::ui::containers::_Header::Layout >();
HXLINE( 206)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::_Header::Builder >();
            	}


void Header_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_d81e3849569e5e7d_523_registerBehaviours)
HXDLIN( 523)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer Header_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_68ace50d51adcb50_651_cloneComponent)
HXLINE( 441)		 ::haxe::ui::containers::Header c = ( ( ::haxe::ui::containers::Header)(this->super::cloneComponent()) );
HXLINE( 456)		{
...
HXLINE( 465)		return c;
 ...
 ::haxe::ui::core::ComponentContainer Header_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_d81e3849569e5e7d_493_self)
HXDLIN( 493)		return  ::haxe::ui::containers::Header_obj::__alloc( HX_CTX );
            	}
