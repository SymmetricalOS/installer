...
HX_DEFINE_STACK_FRAME(_hx_pos_3ac0b4693b34d312_901_new,"haxe.ui.containers._TableView.RemoveColumn","new",0x258122fc,"haxe.ui.containers._TableView.RemoveColumn.new","haxe/ui/containers/TableView.hx",901,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac0b4693b34d312_902_call,"haxe.ui.containers._TableView.RemoveColumn","call",0xa4350e82,"haxe.ui.containers._TableView.RemoveColumn.call","haxe/ui/containers/TableView.hx",902,0x8a42a716)
namespace haxe{
namespace ui{
...
void RemoveColumn_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_3ac0b4693b34d312_901_new)
HXDLIN( 901)		super::__construct(component);
            	}
...
bool RemoveColumn_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType RemoveColumn_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_3ac0b4693b34d312_902_call)
HXLINE( 903)		 ::haxe::ui::containers::Header header = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::containers::Header >(),null(),null()).StaticCast<  ::haxe::ui::containers::Header >();
HXLINE( 904)		if (::hx::IsNull( header )) {
HXLINE( 905)			return null();
            		}
HXLINE( 907)		{
HXLINE( 907)			int _g = 0;
HXDLIN( 907)			::Array< ::Dynamic> _g1 = header->findComponents(null(),::hx::ClassOf< ::haxe::ui::components::Column >(),null());
HXDLIN( 907)			while((_g < _g1->length)){
HXLINE( 907)				 ::haxe::ui::components::Column c = _g1->__get(_g).StaticCast<  ::haxe::ui::components::Column >();
HXDLIN( 907)				_g = (_g + 1);
HXLINE( 908)				if (::hx::IsNull( c->get_id() )) {
HXLINE( 909)					continue;
            				}
HXLINE( 911)				if (::hx::IsEq( c->get_text(),param )) {
HXLINE( 912)					header->removeComponent(c,null(),null());
HXLINE( 913)					goto _hx_goto_1;
            				}
            			}
            			_hx_goto_1:;
            		}
HXLINE( 916)		return null();
            	}
