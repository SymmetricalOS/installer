...
HX_DEFINE_STACK_FRAME(_hx_pos_fbe547e797c77141_237_new,"haxe.ui.components._TextField.TextBehaviour","new",0x4854ee28,"haxe.ui.components._TextField.TextBehaviour.new","haxe/ui/components/TextField.hx",237,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_fbe547e797c77141_238_validateData,"haxe.ui.components._TextField.TextBehaviour","validateData",0x70043f18,"haxe.ui.components._TextField.TextBehaviour.validateData","haxe/ui/components/TextField.hx",238,0x9dfe9498)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_fbe547e797c77141_237_new)
...
void TextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_fbe547e797c77141_238_validateData)
HXLINE( 239)		 ::haxe::ui::components::TextField textfield = ::hx::TCast<  ::haxe::ui::components::TextField >::cast(this->_component);
HXLINE( 240)		::haxe::ui::components::_TextField::TextFieldHelper_obj::validateText(textfield,::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
HXLINE( 242)		bool _hx_tmp;
HXDLIN( 242)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 242)			 ::haxe::ui::util::VariantType _hx_tmp1 = this->_value;
HXDLIN( 242)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::neq(_hx_tmp1,::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(HX_("",00,00,00,00)));
            		}
            		else {
HXLINE( 242)			_hx_tmp = false;
            		}
HXDLIN( 242)		if (_hx_tmp) {
HXLINE( 243)			this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(textfield->getTextInput()->get_text());
            		}
            	}
