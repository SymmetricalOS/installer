...
HX_LOCAL_STACK_FRAME(_hx_pos_3b5960fab4234575_523_registerBehaviours,"haxe.ui.containers.dialogs.Dialog","registerBehaviours",0xd64b78d2,"haxe.ui.containers.dialogs.Dialog.registerBehaviours","haxe/ui/macros/Macros.hx",523,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8282b85acad398e5_651_cloneComponent,"haxe.ui.containers.dialogs.Dialog","cloneComponent",0xa86e8a19,"haxe.ui.containers.dialogs.Dialog.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",651,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_3b5960fab4234575_493_self,"haxe.ui.containers.dialogs.Dialog","self",0xcd0d8ac5,"haxe.ui.containers.dialogs.Dialog.self","haxe/ui/macros/Macros.hx",493,0x27866361)
namespace haxe{
namespace ui{
...
void Dialog_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_3b5960fab4234575_523_registerBehaviours)
HXDLIN( 523)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer Dialog_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_8282b85acad398e5_651_cloneComponent)
HXLINE( 441)		 ::haxe::ui::containers::dialogs::Dialog c = ( ( ::haxe::ui::containers::dialogs::Dialog)(this->super::cloneComponent()) );
HXLINE( 456)		{
...
HXLINE( 465)		return c;
 ...
 ::haxe::ui::core::ComponentContainer Dialog_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_3b5960fab4234575_493_self)
HXDLIN( 493)		return  ::haxe::ui::containers::dialogs::Dialog_obj::__alloc( HX_CTX );
            	}
