...
HXDLIN(   6)			_g->set(HX_("rightclick",ec,f2,f5,b7),::wx::widgets::EventType_obj::CONTEXT_MENU);
HXDLIN(   6)			_g->set(HX_("rightmousedown",ab,1d,2b,41),::wx::widgets::EventType_obj::RIGHT_DOWN);
HXDLIN(   6)			_g->set(HX_("rightmouseup",64,77,d0,dd),::wx::widgets::EventType_obj::RIGHT_UP);
...
HXDLIN(  21)			_g->set(::wx::widgets::EventType_obj::MOTION,HX_("mousemove",b6,6f,dc,09));
HXDLIN(  21)			_g->set(::wx::widgets::EventType_obj::ENTER_WINDOW,HX_("mouseover",f9,1d,34,0b));
HXDLIN(  21)			_g->set(::wx::widgets::EventType_obj::LEAVE_WINDOW,HX_("mouseout",89,2f,36,a4));
HXDLIN(  21)			_g->set(::wx::widgets::EventType_obj::LEFT_DOWN,HX_("mousedown",07,85,e9,03));
HXDLIN(  21)			_g->set(::wx::widgets::EventType_obj::LEFT_UP,HX_("mouseup",c0,0f,73,c0));
HXDLIN(  21)			_g->set(::wx::widgets::EventType_obj::MOUSEWHEEL,HX_("mousewheel",56,b8,59,54));
HXDLIN(  21)			_g->set(::wx::widgets::EventType_obj::CONTEXT_MENU,HX_("rightclick",ec,f2,f5,b7));
HXDLIN(  21)			_g->set(::wx::widgets::EventType_obj::RIGHT_DOWN,HX_("rightmousedown",ab,1d,2b,41));
HXDLIN(  21)			_g->set(::wx::widgets::EventType_obj::RIGHT_UP,HX_("rightmouseup",64,77,d0,dd));
HXDLIN(  21)			_g->set(::wx::widgets::EventType_obj::LEFT_DCLICK,HX_("doubleclick",97,93,48,3a));
HXDLIN(  21)			_g->set(::wx::widgets::EventType_obj::SET_FOCUS,HX_("focusin",bd,61,83,41));
HXDLIN(  21)			_g->set(::wx::widgets::EventType_obj::KILL_FOCUS,HX_("focusout",b6,b7,76,11));
HXDLIN(  21)			return _g;
            		}
            		HX_END_LOCAL_FUNC0(return)
