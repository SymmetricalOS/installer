...
HX_DEFINE_STACK_FRAME(_hx_pos_79d1b1c8e25449f6_882_new,"haxe.ui.containers._TableView.AddColumn","new",0x91048779,"haxe.ui.containers._TableView.AddColumn.new","haxe/ui/containers/TableView.hx",882,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_79d1b1c8e25449f6_883_call,"haxe.ui.containers._TableView.AddColumn","call",0x4ba99765,"haxe.ui.containers._TableView.AddColumn.call","haxe/ui/containers/TableView.hx",883,0x8a42a716)
namespace haxe{
namespace ui{
...
void AddColumn_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_79d1b1c8e25449f6_882_new)
HXDLIN( 882)		super::__construct(component);
            	}
...
bool AddColumn_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType AddColumn_obj::call( ::Dynamic param){
            	HX_GC_STACKFRAME(&_hx_pos_79d1b1c8e25449f6_883_call)
HXLINE( 884)		 ::haxe::ui::containers::Header header = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::containers::Header >(),null(),null()).StaticCast<  ::haxe::ui::containers::Header >();
HXLINE( 885)		if (::hx::IsNull( header )) {
HXLINE( 886)			header =  ::haxe::ui::containers::Header_obj::__alloc( HX_CTX );
HXLINE( 887)			this->_component->addComponent(header);
            		}
HXLINE( 889)		 ::haxe::ui::components::Column column =  ::haxe::ui::components::Column_obj::__alloc( HX_CTX );
HXLINE( 890)		column->set_text(( (::String)(param) ));
HXLINE( 891)		::String columnId = ( (::String)(param) );
HXLINE( 892)		columnId = ::StringTools_obj::replace(columnId,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00));
HXLINE( 893)		columnId = ::StringTools_obj::replace(columnId,HX_("*",2a,00,00,00),HX_("",00,00,00,00));
HXLINE( 894)		column->set_id(columnId);
HXLINE( 895)		header->addComponent(column);
HXLINE( 896)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(column);
            	}
