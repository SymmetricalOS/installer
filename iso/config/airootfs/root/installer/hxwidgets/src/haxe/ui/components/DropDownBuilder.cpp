...
HX_DEFINE_STACK_FRAME(_hx_pos_ff5df7ac87c4dee2_953_new,"haxe.ui.components.DropDownBuilder","new",0xc1a41bf6,"haxe.ui.components.DropDownBuilder.new","haxe/ui/components/DropDown.hx",953,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_ff5df7ac87c4dee2_962_get_handler,"haxe.ui.components.DropDownBuilder","get_handler",0xb056e177,"haxe.ui.components.DropDownBuilder.get_handler","haxe/ui/components/DropDown.hx",962,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_ff5df7ac87c4dee2_974_onReady,"haxe.ui.components.DropDownBuilder","onReady",0x91e50d5a,"haxe.ui.components.DropDownBuilder.onReady","haxe/ui/components/DropDown.hx",974,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_ff5df7ac87c4dee2_981_create,"haxe.ui.components.DropDownBuilder","create",0x62e5fd26,"haxe.ui.components.DropDownBuilder.create","haxe/ui/components/DropDown.hx",981,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_ff5df7ac87c4dee2_988_destroy,"haxe.ui.components.DropDownBuilder","destroy",0x3972fb90,"haxe.ui.components.DropDownBuilder.destroy","haxe/ui/components/DropDown.hx",988,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_ff5df7ac87c4dee2_997_addComponent,"haxe.ui.components.DropDownBuilder","addComponent",0x2018a406,"haxe.ui.components.DropDownBuilder.addComponent","haxe/ui/components/DropDown.hx",997,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_ff5df7ac87c4dee2_1009_onThemeChanged,"haxe.ui.components.DropDownBuilder","onThemeChanged",0xe4304dd4,"haxe.ui.components.DropDownBuilder.onThemeChanged","haxe/ui/components/DropDown.hx",1009,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_ff5df7ac87c4dee2_948_boot,"haxe.ui.components.DropDownBuilder","boot",0xa60d5bdc,"haxe.ui.components.DropDownBuilder.boot","haxe/ui/components/DropDown.hx",948,0x145b8c86)
namespace haxe{
namespace ui{
namespace components{

void DropDownBuilder_obj::__construct( ::haxe::ui::components::DropDown dropdown){
            	HX_STACKFRAME(&_hx_pos_ff5df7ac87c4dee2_953_new)
HXLINE( 954)		super::__construct(dropdown);
HXLINE( 955)		this->_dropdown = dropdown;
HXLINE( 957)		{
HXLINE( 957)			::Dynamic this1 = ::haxe::ui::components::DropDownBuilder_obj::HANDLER_MAP;
HXDLIN( 957)			( ( ::haxe::ds::StringMap)(this1) )->set(HX_("list",5e,1c,b3,47),::Type_obj::getClassName(::hx::ClassOf< ::haxe::ui::components::_DropDown::ListDropDownHandler >()));
            		}
HXLINE( 958)		{
HXLINE( 958)			::Dynamic this2 = ::haxe::ui::components::DropDownBuilder_obj::HANDLER_MAP;
HXDLIN( 958)			( ( ::haxe::ds::StringMap)(this2) )->set(HX_("date",2e,56,63,42),::Type_obj::getClassName(::hx::ClassOf< ::haxe::ui::components::CalendarDropDownHandler >()));
            		}
            	}
...
::Dynamic DropDownBuilder_obj::get_handler(){
            	HX_STACKFRAME(&_hx_pos_ff5df7ac87c4dee2_962_get_handler)
HXLINE( 963)		if (::hx::IsNull( this->_handler )) {
HXLINE( 964)			::Dynamic this1 = ::haxe::ui::components::DropDownBuilder_obj::HANDLER_MAP;
HXDLIN( 964)			::String handlerClass = ( ( ::haxe::ds::StringMap)(this1) )->get_string(this->_dropdown->get_type());
HXLINE( 965)			if (::hx::IsNull( handlerClass )) {
HXLINE( 966)				handlerClass = this->_dropdown->get_type();
            			}
HXLINE( 968)			::hx::Class _hx_tmp = ::Type_obj::resolveClass(handlerClass);
HXDLIN( 968)			this->_handler = ::Type_obj::createInstance(_hx_tmp,::cpp::VirtualArray_obj::__new(1)->init(0,this->_dropdown));
            		}
HXLINE( 971)		return this->_handler;
            	}
...
void DropDownBuilder_obj::onReady(){
            	HX_STACKFRAME(&_hx_pos_ff5df7ac87c4dee2_974_onReady)
HXLINE( 975)		this->super::onReady();
HXLINE( 976)		if (::hx::IsNull( this->_dropdown->get_text() )) {
HXLINE( 977)			::haxe::ui::components::IDropDownHandler_obj::applyDefault(this->get_handler());
            		}
            	}


void DropDownBuilder_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_ff5df7ac87c4dee2_981_create)
HXLINE( 982)		this->_dropdown->set_toggle(true);
HXLINE( 983)		if (::hx::IsNull( this->_dropdown->findComponent(null(),::hx::ClassOf< ::haxe::ui::core::ItemRenderer >(),null(),null()).StaticCast<  ::haxe::ui::core::ItemRenderer >() )) {
HXLINE( 984)			 ::haxe::ui::components::DropDown _hx_tmp = this->_dropdown;
HXDLIN( 984)			_hx_tmp->addComponent( ::haxe::ui::core::BasicItemRenderer_obj::__alloc( HX_CTX ));
            		}
            	}


void DropDownBuilder_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_ff5df7ac87c4dee2_988_destroy)
HXLINE( 989)		 ::haxe::ui::components::DropDownEvents events = ::hx::TCast<  ::haxe::ui::components::DropDownEvents >::cast(this->_dropdown->_internalEvents);
HXLINE( 990)		events->hideDropDown();
HXLINE( 991)		if (::hx::IsNotNull( events->_wrapper )) {
HXLINE( 992)			::haxe::ui::core::Screen_obj::get_instance()->removeComponent(events->_wrapper,null());
HXLINE( 993)			events->_wrapper = null();
            		}
            	}


 ::haxe::ui::core::Component DropDownBuilder_obj::addComponent( ::haxe::ui::core::Component child){
            	HX_STACKFRAME(&_hx_pos_ff5df7ac87c4dee2_997_addComponent)
HXLINE( 998)		if (::Std_obj::isOfType(child,::hx::ClassOf< ::haxe::ui::core::ItemRenderer >())) {
HXLINE( 999)			 ::haxe::ui::components::DropDown _hx_tmp = this->_dropdown;
HXDLIN( 999)			_hx_tmp->set_itemRenderer(( ( ::haxe::ui::core::ItemRenderer)(Dynamic( child->cloneComponent()).StaticCast<  ::haxe::ui::core::Component >()) ));
HXLINE(1000)			bool _hx_tmp1;
HXDLIN(1000)			if ((child->get_id() != HX_("dropdown-renderer",3f,3c,7f,af))) {
HXLINE(1000)				_hx_tmp1 = (child->get_id() == HX_("dropdownRenderer",74,ee,58,36));
            			}
            			else {
HXLINE(1000)				_hx_tmp1 = true;
            			}
HXDLIN(1000)			if (_hx_tmp1) {
HXLINE(1001)				return child;
            			}
            		}
HXLINE(1004)		return this->super::addComponent(child);
            	}


void DropDownBuilder_obj::onThemeChanged(){
            	HX_STACKFRAME(&_hx_pos_ff5df7ac87c4dee2_1009_onThemeChanged)
HXDLIN(1009)		if (::hx::IsNotNull( this->_handler )) {
HXLINE(1010)			 ::haxe::ui::core::Screen _hx_tmp = ::haxe::ui::core::Screen_obj::get_instance();
HXDLIN(1010)			_hx_tmp->invalidateChildren(::haxe::ui::components::IDropDownHandler_obj::get_component(this->_handler),null());
HXLINE(1011)			 ::haxe::ui::core::Screen _hx_tmp1 = ::haxe::ui::core::Screen_obj::get_instance();
HXDLIN(1011)			_hx_tmp1->onThemeChangedChildren(::haxe::ui::components::IDropDownHandler_obj::get_component(this->_handler));
            		}
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_ff5df7ac87c4dee2_948_boot)
HXDLIN( 948)		HANDLER_MAP =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
}
