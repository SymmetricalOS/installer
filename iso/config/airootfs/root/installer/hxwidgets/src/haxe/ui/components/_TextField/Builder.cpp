...
HX_DEFINE_STACK_FRAME(_hx_pos_51c0c758e7e931c3_474_new,"haxe.ui.components._TextField.Builder","new",0x70429273,"haxe.ui.components._TextField.Builder.new","haxe/ui/components/TextField.hx",474,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_51c0c758e7e931c3_479_applyStyle,"haxe.ui.components._TextField.Builder","applyStyle",0x327b1730,"haxe.ui.components._TextField.Builder.applyStyle","haxe/ui/components/TextField.hx",479,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_51c0c758e7e931c3_493_isHtml,"haxe.ui.components._TextField.Builder","isHtml",0x6342e642,"haxe.ui.components._TextField.Builder.isHtml","haxe/ui/components/TextField.hx",493,0x9dfe9498)
namespace haxe{
namespace ui{
...
void Builder_obj::__construct( ::haxe::ui::components::TextField textfield){
            	HX_STACKFRAME(&_hx_pos_51c0c758e7e931c3_474_new)
HXLINE( 475)		super::__construct(textfield);
HXLINE( 476)		this->_textfield = textfield;
            	}
...
void Builder_obj::applyStyle( ::haxe::ui::styles::Style style){
            	HX_STACKFRAME(&_hx_pos_51c0c758e7e931c3_479_applyStyle)
HXLINE( 480)		if (::hx::IsNotNull( style->icon )) {
HXLINE( 481)			 ::haxe::ui::components::TextField _hx_tmp = this->_textfield;
HXDLIN( 481)			_hx_tmp->set_icon(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(style->icon));
            		}
HXLINE( 483)		if ((this->_textfield->hasTextInput() == true)) {
HXLINE( 484)			this->_textfield->getTextInput()->set_textStyle(style);
HXLINE( 486)			bool _hx_tmp1;
HXDLIN( 486)			bool _hx_tmp2;
HXDLIN( 486)			bool _hx_tmp3;
HXDLIN( 486)			if ((style->contentType != HX_("auto",6f,df,76,40))) {
HXLINE( 486)				_hx_tmp3 = (style->contentType == HX_("html",6b,95,16,45));
            			}
            			else {
HXLINE( 486)				_hx_tmp3 = true;
            			}
HXDLIN( 486)			if (_hx_tmp3) {
HXLINE( 486)				_hx_tmp2 = this->_textfield->getTextInput()->get_supportsHtml();
            			}
            			else {
HXLINE( 486)				_hx_tmp2 = false;
            			}
HXDLIN( 486)			if (_hx_tmp2) {
HXLINE( 486)				::String v = ::Std_obj::string(this->_textfield->get_text());
HXDLIN( 486)				if (::hx::IsNull( v )) {
HXLINE( 486)					_hx_tmp1 = false;
            				}
            				else {
HXLINE( 486)					_hx_tmp1 = (v.indexOf(HX_("<font ",b5,5d,fb,01),null()) != -1);
            				}
            			}
            			else {
HXLINE( 486)				_hx_tmp1 = false;
...
HXLINE( 487)				 ::haxe::ui::components::TextField _hx_tmp4 = this->_textfield;
HXDLIN( 487)				_hx_tmp4->set_htmlText(this->_textfield->get_text());
            			}
            		}
            	}
...
bool Builder_obj::isHtml(::String v){
            	HX_STACKFRAME(&_hx_pos_51c0c758e7e931c3_493_isHtml)
HXDLIN( 493)		if (::hx::IsNull( v )) {
HXDLIN( 493)			return false;
            		}
            		else {
HXDLIN( 493)			return (v.indexOf(HX_("<font ",b5,5d,fb,01),null()) != -1);
            		}
HXDLIN( 493)		return false;
            	}
