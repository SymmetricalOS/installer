...
HX_LOCAL_STACK_FRAME(_hx_pos_107ba3536cf6d5b6_523_registerBehaviours,"haxe.ui.containers.Grid","registerBehaviours",0xf5002397,"haxe.ui.containers.Grid.registerBehaviours","haxe/ui/macros/Macros.hx",523,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_4e3f01045388a5f3_651_cloneComponent,"haxe.ui.containers.Grid","cloneComponent",0x6f5b2e5e,"haxe.ui.containers.Grid.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",651,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_107ba3536cf6d5b6_493_self,"haxe.ui.containers.Grid","self",0xb2bb16ca,"haxe.ui.containers.Grid.self","haxe/ui/macros/Macros.hx",493,0x27866361)
namespace haxe{
namespace ui{
...
void Grid_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_107ba3536cf6d5b6_523_registerBehaviours)
HXDLIN( 523)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer Grid_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_4e3f01045388a5f3_651_cloneComponent)
HXLINE( 441)		 ::haxe::ui::containers::Grid c = ( ( ::haxe::ui::containers::Grid)(this->super::cloneComponent()) );
HXLINE( 452)		c->set_columns(this->get_columns());
HXLINE( 456)		{
...
HXLINE( 465)		return c;
 ...
 ::haxe::ui::core::ComponentContainer Grid_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_107ba3536cf6d5b6_493_self)
HXDLIN( 493)		return  ::haxe::ui::containers::Grid_obj::__alloc( HX_CTX );
            	}
