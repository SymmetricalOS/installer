...
HX_DEFINE_STACK_FRAME(_hx_pos_9b9107e482845aa5_306_new,"haxe.ui.components._TextField.SelectionEndIndexBehaviour","new",0xc6fea8e6,"haxe.ui.components._TextField.SelectionEndIndexBehaviour.new","haxe/ui/components/TextField.hx",306,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_9b9107e482845aa5_308_get,"haxe.ui.components._TextField.SelectionEndIndexBehaviour","get",0xc6f9591c,"haxe.ui.components._TextField.SelectionEndIndexBehaviour.get","haxe/ui/components/TextField.hx",308,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_9b9107e482845aa5_310_set,"haxe.ui.components._TextField.SelectionEndIndexBehaviour","set",0xc7027428,"haxe.ui.components._TextField.SelectionEndIndexBehaviour.set","haxe/ui/components/TextField.hx",310,0x9dfe9498)
namespace haxe{
namespace ui{
...
void SelectionEndIndexBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_9b9107e482845aa5_306_new)
...
bool SelectionEndIndexBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType SelectionEndIndexBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_9b9107e482845aa5_308_get)
HXDLIN( 308)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(this->_component->getTextInput()->get_selectionEndIndex());
            	}


void SelectionEndIndexBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_9b9107e482845aa5_310_set)
...
HXDLIN( 313)		_hx_tmp->set_selectionEndIndex(( (int)(::haxe::ui::util::_Variant::Variant_Impl__obj::toInt(value)) ));
            	}
