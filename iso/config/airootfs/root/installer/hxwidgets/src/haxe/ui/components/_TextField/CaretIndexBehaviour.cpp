...
HX_DEFINE_STACK_FRAME(_hx_pos_608b21ffb473e6f5_281_new,"haxe.ui.components._TextField.CaretIndexBehaviour","new",0x7a1a0f86,"haxe.ui.components._TextField.CaretIndexBehaviour.new","haxe/ui/components/TextField.hx",281,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_608b21ffb473e6f5_283_get,"haxe.ui.components._TextField.CaretIndexBehaviour","get",0x7a14bfbc,"haxe.ui.components._TextField.CaretIndexBehaviour.get","haxe/ui/components/TextField.hx",283,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_608b21ffb473e6f5_285_set,"haxe.ui.components._TextField.CaretIndexBehaviour","set",0x7a1ddac8,"haxe.ui.components._TextField.CaretIndexBehaviour.set","haxe/ui/components/TextField.hx",285,0x9dfe9498)
namespace haxe{
namespace ui{
...
void CaretIndexBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_608b21ffb473e6f5_281_new)
...
bool CaretIndexBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType CaretIndexBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_608b21ffb473e6f5_283_get)
HXDLIN( 283)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(this->_component->getTextInput()->get_caretIndex());
            	}


void CaretIndexBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_608b21ffb473e6f5_285_set)
HXLINE( 286)		this->super::set(value);
HXLINE( 287)		this->_component->syncComponentValidation(null());
HXLINE( 288)		 ::haxe::ui::core::TextInput _hx_tmp = this->_component->getTextInput();
HXDLIN( 288)		_hx_tmp->set_caretIndex(( (int)(::haxe::ui::util::_Variant::Variant_Impl__obj::toInt(value)) ));
            	}
