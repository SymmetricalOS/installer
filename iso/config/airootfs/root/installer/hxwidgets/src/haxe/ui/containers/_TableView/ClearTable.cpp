...
HX_DEFINE_STACK_FRAME(_hx_pos_fe42cf05b4600f11_862_new,"haxe.ui.containers._TableView.ClearTable","new",0x4f0d6b83,"haxe.ui.containers._TableView.ClearTable.new","haxe/ui/containers/TableView.hx",862,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_fe42cf05b4600f11_863_call,"haxe.ui.containers._TableView.ClearTable","call",0xd5683c1b,"haxe.ui.containers._TableView.ClearTable.call","haxe/ui/containers/TableView.hx",863,0x8a42a716)
namespace haxe{
namespace ui{
...
void ClearTable_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_fe42cf05b4600f11_862_new)
HXDLIN( 862)		super::__construct(component);
            	}
...
bool ClearTable_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType ClearTable_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_fe42cf05b4600f11_863_call)
HXLINE( 864)		if ((( (bool)(param) ) == true)) {
HXLINE( 865)			if (::hx::IsNotNull( ::hx::TCast<  ::haxe::ui::containers::TableView >::cast(this->_component)->get_itemRenderer() )) {
HXLINE( 866)				::hx::TCast<  ::haxe::ui::containers::TableView >::cast(this->_component)->get_itemRenderer()->removeAllComponents(null());
            			}
HXLINE( 868)			 ::haxe::ui::containers::Header header = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::containers::Header >(),null(),null()).StaticCast<  ::haxe::ui::containers::Header >();
HXLINE( 869)			if (::hx::IsNotNull( header )) {
HXLINE( 870)				header->removeAllComponents(null());
            			}
            		}
HXLINE( 873)		 ::haxe::ui::containers::Box contents = this->_component->findComponent(HX_("tableview-contents",74,2a,d3,78),::hx::ClassOf< ::haxe::ui::containers::Box >(),true,HX_("css",c3,83,4b,00)).StaticCast<  ::haxe::ui::containers::Box >();
HXLINE( 874)		if (::hx::IsNotNull( contents )) {
HXLINE( 875)			contents->removeAllComponents(null());
            		}
