...
HX_DEFINE_STACK_FRAME(_hx_pos_277687b33c7f0cbf_232_new,"haxe.ui.components.CheckBoxBuilder","new",0xa70b7344,"haxe.ui.components.CheckBoxBuilder.new","haxe/ui/components/CheckBox.hx",232,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_277687b33c7f0cbf_239_create,"haxe.ui.components.CheckBoxBuilder","create",0x4cfdaa98,"haxe.ui.components.CheckBoxBuilder.create","haxe/ui/components/CheckBox.hx",239,0xaeb3e5d4)
...
HX_LOCAL_STACK_FRAME(_hx_pos_277687b33c7f0cbf_255_get_cssName,"haxe.ui.components.CheckBoxBuilder","get_cssName",0x59ea46a9,"haxe.ui.components.CheckBoxBuilder.get_cssName","haxe/ui/components/CheckBox.hx",255,0xaeb3e5d4)
namespace haxe{
namespace ui{
namespace components{

void CheckBoxBuilder_obj::__construct( ::haxe::ui::components::CheckBox checkbox){
            	HX_STACKFRAME(&_hx_pos_277687b33c7f0cbf_232_new)
HXLINE( 233)		super::__construct(checkbox);
HXLINE( 234)		this->_checkbox = checkbox;
HXLINE( 235)		this->_checkbox->set_allowFocus(false);
            	}
...
void CheckBoxBuilder_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_277687b33c7f0cbf_239_create)
HXDLIN( 239)		if (::hx::IsNull( this->_checkbox->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::CheckBoxValue >(),null(),null()).StaticCast<  ::haxe::ui::components::CheckBoxValue >() )) {
HXLINE( 240)			 ::haxe::ui::components::CheckBoxValue value =  ::haxe::ui::components::CheckBoxValue_obj::__alloc( HX_CTX );
HXLINE( 241)			value->set_id(((HX_("",00,00,00,00) + this->_checkbox->get_cssName()) + HX_("-value",24,bc,c7,2f)));
HXLINE( 242)			value->addClass(((HX_("",00,00,00,00) + this->_checkbox->get_cssName()) + HX_("-value",24,bc,c7,2f)),null(),null());
HXLINE( 243)			value->set_scriptAccess(false);
HXLINE( 244)			this->_checkbox->addComponent(value);
            		}
            	}
...
HXLINE( 106)		 ::haxe::ui::core::Component c = this->_component;
HXDLIN( 106)		 ::haxe::ui::core::Component c1 = c->findComponent(((HX_("",00,00,00,00) + this->_checkbox->get_cssName()) + HX_("-label",a7,4a,be,6d)),::hx::ClassOf< ::haxe::ui::core::Component >(),null(),null()).StaticCast<  ::haxe::ui::core::Component >();
...
HXLINE( 111)					_hx_tmp = ::hx::IsNotEq( c1->get_customStyle()->color,style->color );
            				}
            				else {
HXLINE( 111)					_hx_tmp = false;
            				}
HXDLIN( 111)				if (_hx_tmp) {
HXLINE( 112)					c1->get_customStyle()->color = style->color;
HXLINE( 113)					invalidate = true;
            				}
HXLINE( 111)				bool _hx_tmp1;
HXDLIN( 111)				if (::hx::IsNotNull( style->fontName )) {
HXLINE( 111)					_hx_tmp1 = (c1->get_customStyle()->fontName != style->fontName);
            				}
            				else {
HXLINE( 111)					_hx_tmp1 = false;
            				}
HXDLIN( 111)				if (_hx_tmp1) {
HXLINE( 112)					c1->get_customStyle()->fontName = style->fontName;
HXLINE( 113)					invalidate = true;
            				}
HXLINE( 111)				bool _hx_tmp2;
HXDLIN( 111)				if (::hx::IsNotNull( style->fontSize )) {
HXLINE( 111)					_hx_tmp2 = ::hx::IsNotEq( c1->get_customStyle()->fontSize,style->fontSize );
            				}
            				else {
HXLINE( 111)					_hx_tmp2 = false;
            				}
HXDLIN( 111)				if (_hx_tmp2) {
HXLINE( 112)					c1->get_customStyle()->fontSize = style->fontSize;
HXLINE( 113)					invalidate = true;
            				}
HXLINE( 111)				bool _hx_tmp3;
HXDLIN( 111)				if (::hx::IsNotNull( style->cursor )) {
HXLINE( 111)					_hx_tmp3 = (c1->get_customStyle()->cursor != style->cursor);
            				}
            				else {
...
HXLINE( 111)					_hx_tmp4 = (c1->get_customStyle()->textAlign != style->textAlign);
            				}
            				else {
HXLINE( 111)					_hx_tmp4 = false;
            				}
HXDLIN( 111)				if (_hx_tmp4) {
HXLINE( 112)					c1->get_customStyle()->textAlign = style->textAlign;
HXLINE( 113)					invalidate = true;
            				}
HXLINE( 111)				bool _hx_tmp5;
HXDLIN( 111)				if (::hx::IsNotNull( style->fontBold )) {
HXLINE( 111)					_hx_tmp5 = ::hx::IsNotEq( c1->get_customStyle()->fontBold,style->fontBold );
            				}
            				else {
HXLINE( 111)					_hx_tmp5 = false;
            				}
HXDLIN( 111)				if (_hx_tmp5) {
HXLINE( 112)					c1->get_customStyle()->fontBold = style->fontBold;
HXLINE( 113)					invalidate = true;
            				}
HXLINE( 111)				bool _hx_tmp6;
HXDLIN( 111)				if (::hx::IsNotNull( style->fontUnderline )) {
HXLINE( 111)					_hx_tmp6 = ::hx::IsNotEq( c1->get_customStyle()->fontUnderline,style->fontUnderline );
            				}
            				else {
HXLINE( 111)					_hx_tmp6 = false;
            				}
HXDLIN( 111)				if (_hx_tmp6) {
HXLINE( 112)					c1->get_customStyle()->fontUnderline = style->fontUnderline;
HXLINE( 113)					invalidate = true;
            				}
HXLINE( 111)				bool _hx_tmp7;
HXDLIN( 111)				if (::hx::IsNotNull( style->fontItalic )) {
HXLINE( 111)					_hx_tmp7 = ::hx::IsNotEq( c1->get_customStyle()->fontItalic,style->fontItalic );
            				}
            				else {
HXLINE( 111)					_hx_tmp7 = false;
            				}
HXDLIN( 111)				if (_hx_tmp7) {
HXLINE( 112)					c1->get_customStyle()->fontItalic = style->fontItalic;
HXLINE( 113)					invalidate = true;
            				}
            			}
...
::String CheckBoxBuilder_obj::get_cssName(){
            	HX_STACKFRAME(&_hx_pos_277687b33c7f0cbf_255_get_cssName)
HXDLIN( 255)		return HX_("checkbox",43,d2,f5,ac);
            	}
