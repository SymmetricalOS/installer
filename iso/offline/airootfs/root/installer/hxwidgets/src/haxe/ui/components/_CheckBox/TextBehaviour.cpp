...
HX_DEFINE_STACK_FRAME(_hx_pos_0a71c32d5c944f7b_111_new,"haxe.ui.components._CheckBox.TextBehaviour","new",0x5e742010,"haxe.ui.components._CheckBox.TextBehaviour.new","haxe/ui/components/CheckBox.hx",111,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_0a71c32d5c944f7b_112_validateData,"haxe.ui.components._CheckBox.TextBehaviour","validateData",0xa2739030,"haxe.ui.components._CheckBox.TextBehaviour.validateData","haxe/ui/components/CheckBox.hx",112,0xaeb3e5d4)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_0a71c32d5c944f7b_111_new)
...
void TextBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_0a71c32d5c944f7b_112_validateData)
HXLINE( 113)		 ::haxe::ui::components::Label label = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Label >(),false,null()).StaticCast<  ::haxe::ui::components::Label >();
HXLINE( 114)		if (::hx::IsNull( label )) {
HXLINE( 115)			label =  ::haxe::ui::components::Label_obj::__alloc( HX_CTX );
HXLINE( 116)			label->set_id(((HX_("",00,00,00,00) + this->_component->get_cssName()) + HX_("-label",a7,4a,be,6d)));
HXLINE( 117)			label->addClass(((HX_("",00,00,00,00) + this->_component->get_cssName()) + HX_("-label",a7,4a,be,6d)),null(),null());
HXLINE( 118)			label->set_scriptAccess(false);
HXLINE( 119)			this->_component->addComponent(label);
HXLINE( 120)			{
HXLINE( 120)				 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 120)				_this->invalidateComponent(HX_("style",31,a5,1d,84),false);
HXDLIN( 120)				_this->_style = null();
            			}
            		}
HXLINE( 123)		label->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
