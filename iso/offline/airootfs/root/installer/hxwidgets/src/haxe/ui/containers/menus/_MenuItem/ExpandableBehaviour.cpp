...
HXLINE(  72)			 ::haxe::ui::util::VariantType _hx_tmp2 = this->_value;
HXDLIN(  72)			if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp2,::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false))) {
