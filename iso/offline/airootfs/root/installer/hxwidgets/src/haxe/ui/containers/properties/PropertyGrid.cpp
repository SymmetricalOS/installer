...
HX_LOCAL_STACK_FRAME(_hx_pos_19d410d7a2baa776_193_registerComposite,"haxe.ui.containers.properties.PropertyGrid","registerComposite",0xe94b4aa2,"haxe.ui.containers.properties.PropertyGrid.registerComposite","haxe/ui/macros/Macros.hx",193,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_19d410d7a2baa776_522_registerBehaviours,"haxe.ui.containers.properties.PropertyGrid","registerBehaviours",0xbb95109b,"haxe.ui.containers.properties.PropertyGrid.registerBehaviours","haxe/ui/macros/Macros.hx",522,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_19d410d7a2baa776_566_get_popupStyleNames,"haxe.ui.containers.properties.PropertyGrid","get_popupStyleNames",0xe204f638,"haxe.ui.containers.properties.PropertyGrid.get_popupStyleNames","haxe/ui/macros/Macros.hx",566,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_19d410d7a2baa776_599_set_popupStyleNames,"haxe.ui.containers.properties.PropertyGrid","set_popupStyleNames",0x1ea1e944,"haxe.ui.containers.properties.PropertyGrid.set_popupStyleNames","haxe/ui/macros/Macros.hx",599,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8067355f8c7edd2a_651_cloneComponent,"haxe.ui.containers.properties.PropertyGrid","cloneComponent",0xda2c4962,"haxe.ui.containers.properties.PropertyGrid.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",651,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_19d410d7a2baa776_493_self,"haxe.ui.containers.properties.PropertyGrid","self",0xaf1d04ce,"haxe.ui.containers.properties.PropertyGrid.self","haxe/ui/macros/Macros.hx",493,0x27866361)
namespace haxe{
namespace ui{
...
void PropertyGrid_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_19d410d7a2baa776_193_registerComposite)
HXLINE( 194)		this->super::registerComposite();
HXLINE( 202)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGrid::Events >();
HXLINE( 206)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGrid::Builder >();
            	}


void PropertyGrid_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_19d410d7a2baa776_522_registerBehaviours)
HXLINE( 523)		this->super::registerBehaviours();
HXLINE( 632)		this->behaviours->_hx_register(HX_("popupStyleNames",23,e6,6b,96),::hx::ClassOf< ::haxe::ui::behaviours::DefaultBehaviour >(),null());
            	}


::String PropertyGrid_obj::get_popupStyleNames(){
            	HX_STACKFRAME(&_hx_pos_19d410d7a2baa776_566_get_popupStyleNames)
HXLINE( 567)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 568)			return null();
            		}
HXLINE( 570)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->behaviours->get(HX_("popupStyleNames",23,e6,6b,96)));
            	}
...
::String PropertyGrid_obj::set_popupStyleNames(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_19d410d7a2baa776_599_set_popupStyleNames)
HXLINE( 600)		{
...
HXLINE( 603)						::haxe::ui::locale::LocaleManager_obj::get_instance()->registerComponent(( ( ::haxe::ui::core::Component)(::hx::ObjectPtr<OBJ_>(this)) ),HX_("popupStyleNames",23,e6,6b,96),null(),value,null());
...
HXDLIN( 608)		_hx_tmp2->set(HX_("popupStyleNames",23,e6,6b,96),::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(value));
HXLINE( 609)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("propertychange",85,47,b1,35),null(),HX_("popupStyleNames",23,e6,6b,96)));
...
HX_DEFINE_DYNAMIC_FUNC1(PropertyGrid_obj,set_popupStyleNames,return )
 ...
 ::haxe::ui::core::ComponentContainer PropertyGrid_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_8067355f8c7edd2a_651_cloneComponent)
HXLINE( 441)		 ::haxe::ui::containers::properties::PropertyGrid c = ( ( ::haxe::ui::containers::properties::PropertyGrid)(this->super::cloneComponent()) );
HXLINE( 456)		{
...
HXLINE( 465)		return c;
 ...
 ::haxe::ui::core::ComponentContainer PropertyGrid_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_19d410d7a2baa776_493_self)
HXDLIN( 493)		return  ::haxe::ui::containers::properties::PropertyGrid_obj::__alloc( HX_CTX );
            	}
