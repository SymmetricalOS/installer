...
HXLINE( 241)			Float _hx_tmp2 = (( (Float)(button->get_componentWidth()) ) / ( (Float)(2) ));
HXDLIN( 241)			label->set_left((_hx_tmp2 - (( (Float)(label->get_componentWidth()) ) / ( (Float)(2) ))));
            		}
            		else {
HXLINE( 243)			 ::Dynamic _hx_tmp3 = button->get_left();
HXDLIN( 243)			Float _hx_tmp4 = (_hx_tmp3 + button->get_componentWidth());
HXDLIN( 243)			Float _hx_tmp5 = (_hx_tmp4 + (( (Float)(button->get_componentWidth()) ) / ( (Float)(2) )));
HXDLIN( 243)			label->set_left((_hx_tmp5 - (( (Float)(label->get_componentWidth()) ) / ( (Float)(2) ))));
            		}
...
HXLINE( 255)			Float _hx_tmp6 = (( (Float)(this->_component->get_height()) ) / ( (Float)(2) ));
HXDLIN( 255)			extra->set_top((_hx_tmp6 - (( (Float)(extra->get_height()) ) / ( (Float)(2) ))));
            		}
            	}
