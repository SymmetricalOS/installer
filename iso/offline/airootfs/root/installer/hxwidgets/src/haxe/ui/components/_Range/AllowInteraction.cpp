...
HX_DEFINE_STACK_FRAME(_hx_pos_4f21fe1ac88faa51_158_new,"haxe.ui.components._Range.AllowInteraction","new",0x2b135e25,"haxe.ui.components._Range.AllowInteraction.new","haxe/ui/components/Range.hx",158,0x313cba28)
HX_LOCAL_STACK_FRAME(_hx_pos_4f21fe1ac88faa51_160_get,"haxe.ui.components._Range.AllowInteraction","get",0x2b0e0e5b,"haxe.ui.components._Range.AllowInteraction.get","haxe/ui/components/Range.hx",160,0x313cba28)
HX_LOCAL_STACK_FRAME(_hx_pos_4f21fe1ac88faa51_163_set,"haxe.ui.components._Range.AllowInteraction","set",0x2b172967,"haxe.ui.components._Range.AllowInteraction.set","haxe/ui/components/Range.hx",163,0x313cba28)
namespace haxe{
namespace ui{
...
void AllowInteraction_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_4f21fe1ac88faa51_158_new)
HXDLIN( 158)		super::__construct(component);
            	}
...
bool AllowInteraction_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType AllowInteraction_obj::get(){
            	HX_STACKFRAME(&_hx_pos_4f21fe1ac88faa51_160_get)
HXDLIN( 160)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(::hx::IsNotNull( this->_component->_internalEvents ));
            	}


void AllowInteraction_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_4f21fe1ac88faa51_163_set)
HXLINE( 164)		if (::hx::IsEq( this->_component->get_native(),true )) {
HXLINE( 165)			return;
            		}
HXLINE( 168)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(true))) {
HXLINE( 169)			this->_component->registerInternalEvents(::hx::ClassOf< ::haxe::ui::components::_Range::Events >(),null());
            		}
            		else {
HXLINE( 171)			this->_component->unregisterInternalEvents();
            		}
            	}
