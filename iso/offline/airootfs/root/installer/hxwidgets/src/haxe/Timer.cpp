...
HX_DEFINE_STACK_FRAME(_hx_pos_4189ef764fd57f58_81_new,"haxe.Timer","new",0x4136b0cf,"haxe.Timer.new","/usr/share/haxe/std/haxe/Timer.hx",81,0x4b93f3e7)
HX_DEFINE_STACK_FRAME(_hx_pos_4189ef764fd57f58_70_new,"haxe.Timer","new",0x4136b0cf,"haxe.Timer.new","/usr/share/haxe/std/haxe/Timer.hx",70,0x4b93f3e7)
HX_LOCAL_STACK_FRAME(_hx_pos_4189ef764fd57f58_111_stop,"haxe.Timer","stop",0xd1fd70b3,"haxe.Timer.stop","/usr/share/haxe/std/haxe/Timer.hx",111,0x4b93f3e7)
HX_LOCAL_STACK_FRAME(_hx_pos_4189ef764fd57f58_134___default_run,"haxe.Timer","__default_run",0xdc2b9b9c,"haxe.Timer.__default_run","/usr/share/haxe/std/haxe/Timer.hx",134,0x4b93f3e7)
HX_LOCAL_STACK_FRAME(_hx_pos_4189ef764fd57f58_147_delay,"haxe.Timer","delay",0x3ed5f1b2,"haxe.Timer.delay","/usr/share/haxe/std/haxe/Timer.hx",147,0x4b93f3e7)
HX_LOCAL_STACK_FRAME(_hx_pos_4189ef764fd57f58_145_delay,"haxe.Timer","delay",0x3ed5f1b2,"haxe.Timer.delay","/usr/share/haxe/std/haxe/Timer.hx",145,0x4b93f3e7)
namespace haxe{

void Timer_obj::__construct(int time_ms){
            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::haxe::Timer,_gthis) HXARGC(0)
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_4189ef764fd57f58_81_new)
HXLINE(  81)			_gthis->run();
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_STACKFRAME(&_hx_pos_4189ef764fd57f58_70_new)
...
void Timer_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_4189ef764fd57f58_111_stop)
...
void _hx_run(){
            	HX_STACKFRAME(&_hx_pos_4189ef764fd57f58_134___default_run)
            	}
HX_END_LOCAL_FUNC0((void))
HX_END_DEFAULT_FUNC
 ...
 ::haxe::Timer Timer_obj::delay( ::Dynamic f,int time_ms){
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_4189ef764fd57f58_147_delay)
HXLINE( 148)			t->stop();
HXLINE( 149)			f();
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_GC_STACKFRAME(&_hx_pos_4189ef764fd57f58_145_delay)
