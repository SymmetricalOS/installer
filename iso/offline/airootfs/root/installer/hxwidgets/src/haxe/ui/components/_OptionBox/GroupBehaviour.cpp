...
HX_LOCAL_STACK_FRAME(_hx_pos_44013ff82a92d407_58_validateData,"haxe.ui.components._OptionBox.GroupBehaviour","validateData",0xddf1f67f,"haxe.ui.components._OptionBox.GroupBehaviour.validateData","haxe/ui/components/OptionBox.hx",58,0x8f34a36f)
namespace haxe{
namespace ui{
...
HXLINE(  54)		 ::haxe::ui::components::OptionBoxGroups _hx_tmp = ::haxe::ui::components::OptionBoxGroups_obj::get_instance();
HXDLIN(  54)		_hx_tmp->add(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(value),( ( ::haxe::ui::components::OptionBox)(this->_component) ));
            	}


void GroupBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_44013ff82a92d407_58_validateData)
HXDLIN(  58)		 ::haxe::ui::components::OptionBoxGroups _hx_tmp = ::haxe::ui::components::OptionBoxGroups_obj::get_instance();
HXDLIN(  58)		_hx_tmp->add(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value),( ( ::haxe::ui::components::OptionBox)(this->_component) ));
            	}
