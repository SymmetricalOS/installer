...
HX_LOCAL_STACK_FRAME(_hx_pos_b622e79a3ddd17cb_218_get_animatable,"haxe.ui.core.Component","get_animatable",0x5e32d675,"haxe.ui.core.Component.get_animatable","haxe/ui/core/Component.hx",218,0x3bb69e3f)
...
bool Component_obj::get_animatable(){
            	HX_STACKFRAME(&_hx_pos_b622e79a3ddd17cb_218_get_animatable)
...
HXLINE(1839)				if (::hx::IsLessEq( this->get_width(),0 )) {
...
HXLINE(1841)					this->set_width(this->_style->initialWidth);
...
HXLINE(1849)				if (::hx::IsLessEq( this->get_height(),0 )) {
...
HXLINE(1851)					this->set_height(this->_style->initialHeight);
...
bool Component_obj::validateComponentLayout(){
            	HX_STACKFRAME(&_hx_pos_b622e79a3ddd17cb_1872_validateComponentLayout)
...
HXLINE(2010)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("resize",f4,59,7b,08),null(),null()));
...
HXLINE(2049)				if (::hx::IsLessEq( this->get_width(),0 )) {
...
HXLINE(2051)					this->set_width(style->initialWidth);
...
HXLINE(2059)				if (::hx::IsLessEq( this->get_height(),0 )) {
...
HXLINE(2061)					this->set_height(style->initialHeight);
...
HXLINE(2209)			_hx_tmp1 = ::hx::IsGreater( this->get_width(),0 );
            		}
            		else {
...
HXLINE(2212)			_hx_tmp2 = ::hx::IsGreater( this->get_height(),0 );
            		}
            		else {
