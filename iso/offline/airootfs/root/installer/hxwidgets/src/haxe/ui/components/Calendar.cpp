...
HX_LOCAL_STACK_FRAME(_hx_pos_63f1e320bfcbb468_661_previousMonth,"haxe.ui.components.Calendar","previousMonth",0x04ee26ff,"haxe.ui.components.Calendar.previousMonth","haxe/ui/macros/Macros.hx",661,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_63f1e320bfcbb468_661_nextMonth,"haxe.ui.components.Calendar","nextMonth",0xcd86c1c3,"haxe.ui.components.Calendar.nextMonth","haxe/ui/macros/Macros.hx",661,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_63f1e320bfcbb468_661_previousYear,"haxe.ui.components.Calendar","previousYear",0xdd72e6de,"haxe.ui.components.Calendar.previousYear","haxe/ui/macros/Macros.hx",661,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_63f1e320bfcbb468_661_nextYear,"haxe.ui.components.Calendar","nextYear",0xce46d09a,"haxe.ui.components.Calendar.nextYear","haxe/ui/macros/Macros.hx",661,0x27866361)
...
HX_LOCAL_STACK_FRAME(_hx_pos_63f1e320bfcbb468_193_registerComposite,"haxe.ui.components.Calendar","registerComposite",0xd8882b9a,"haxe.ui.components.Calendar.registerComposite","haxe/ui/macros/Macros.hx",193,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_63f1e320bfcbb468_522_registerBehaviours,"haxe.ui.components.Calendar","registerBehaviours",0x219d08a3,"haxe.ui.components.Calendar.registerBehaviours","haxe/ui/macros/Macros.hx",522,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_63f1e320bfcbb468_566_get_date,"haxe.ui.components.Calendar","get_date",0x94507201,"haxe.ui.components.Calendar.get_date","haxe/ui/macros/Macros.hx",566,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_63f1e320bfcbb468_613_set_date,"haxe.ui.components.Calendar","set_date",0x42adcb75,"haxe.ui.components.Calendar.set_date","haxe/ui/macros/Macros.hx",613,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_63f1e320bfcbb468_566_get_selectedDate,"haxe.ui.components.Calendar","get_selectedDate",0xacf71cfc,"haxe.ui.components.Calendar.get_selectedDate","haxe/ui/macros/Macros.hx",566,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_63f1e320bfcbb468_613_set_selectedDate,"haxe.ui.components.Calendar","set_selectedDate",0x03390a70,"haxe.ui.components.Calendar.set_selectedDate","haxe/ui/macros/Macros.hx",613,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8c4be73b40ccdc64_651_cloneComponent,"haxe.ui.components.Calendar","cloneComponent",0xbbc59d6a,"haxe.ui.components.Calendar.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",651,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_63f1e320bfcbb468_493_self,"haxe.ui.components.Calendar","self",0x75667ed6,"haxe.ui.components.Calendar.self","haxe/ui/macros/Macros.hx",493,0x27866361)
namespace haxe{
namespace ui{
...
bool Calendar_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType Calendar_obj::previousMonth(){
            	HX_STACKFRAME(&_hx_pos_63f1e320bfcbb468_661_previousMonth)
HXLINE( 662)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 663)			return null();
            		}
HXLINE( 665)		return this->behaviours->call(HX_("previousMonth",89,d3,53,33),null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Calendar_obj,previousMonth,return )
 ...
 ::haxe::ui::util::VariantType Calendar_obj::nextMonth(){
            	HX_STACKFRAME(&_hx_pos_63f1e320bfcbb468_661_nextMonth)
HXLINE( 662)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 663)			return null();
            		}
HXLINE( 665)		return this->behaviours->call(HX_("nextMonth",4d,e1,a4,b3),null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Calendar_obj,nextMonth,return )
 ...
 ::haxe::ui::util::VariantType Calendar_obj::previousYear(){
            	HX_STACKFRAME(&_hx_pos_63f1e320bfcbb468_661_previousYear)
HXLINE( 662)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 663)			return null();
            		}
HXLINE( 665)		return this->behaviours->call(HX_("previousYear",94,99,e9,f6),null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Calendar_obj,previousYear,return )
 ...
 ::haxe::ui::util::VariantType Calendar_obj::nextYear(){
            	HX_STACKFRAME(&_hx_pos_63f1e320bfcbb468_661_nextYear)
HXLINE( 662)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 663)			return null();
            		}
HXLINE( 665)		return this->behaviours->call(HX_("nextYear",50,70,14,fc),null());
            	}
...
void Calendar_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_63f1e320bfcbb468_193_registerComposite)
HXLINE( 194)		this->super::registerComposite();
HXLINE( 202)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::components::_Calendar::Events >();
HXLINE( 206)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::components::_Calendar::Builder >();
HXLINE( 210)		this->_defaultLayoutClass = ::hx::ClassOf< ::haxe::ui::components::_Calendar::Layout >();
            	}


void Calendar_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_63f1e320bfcbb468_522_registerBehaviours)
HXLINE( 523)		this->super::registerBehaviours();
HXLINE( 632)		this->behaviours->_hx_register(HX_("date",2e,56,63,42),::hx::ClassOf< ::haxe::ui::components::_Calendar::DateBehaviour >(),null());
HXDLIN( 632)		this->behaviours->_hx_register(HX_("selectedDate",29,76,fd,d2),::hx::ClassOf< ::haxe::ui::components::_Calendar::SelectedDateBehaviour >(),null());
HXLINE( 671)		this->behaviours->_hx_register(HX_("previousMonth",89,d3,53,33),::hx::ClassOf< ::haxe::ui::components::_Calendar::PreviousMonthBehaviour >(),null());
HXDLIN( 671)		this->behaviours->_hx_register(HX_("nextMonth",4d,e1,a4,b3),::hx::ClassOf< ::haxe::ui::components::_Calendar::NextMonthBehaviour >(),null());
HXDLIN( 671)		this->behaviours->_hx_register(HX_("previousYear",94,99,e9,f6),::hx::ClassOf< ::haxe::ui::components::_Calendar::PreviousYearBehaviour >(),null());
HXDLIN( 671)		this->behaviours->_hx_register(HX_("nextYear",50,70,14,fc),::hx::ClassOf< ::haxe::ui::components::_Calendar::NextYearBehaviour >(),null());
            	}


 ::Date Calendar_obj::get_date(){
            	HX_STACKFRAME(&_hx_pos_63f1e320bfcbb468_566_get_date)
HXLINE( 567)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 568)			return null();
            		}
HXLINE( 570)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toDate(this->behaviours->get(HX_("date",2e,56,63,42)));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Calendar_obj,get_date,return )
 ...
 ::Date Calendar_obj::set_date( ::Date value){
            	HX_GC_STACKFRAME(&_hx_pos_63f1e320bfcbb468_613_set_date)
...
HXDLIN( 617)		_hx_tmp->set(HX_("date",2e,56,63,42),::haxe::ui::util::_Variant::Variant_Impl__obj::fromDate(value));
HXLINE( 618)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("propertychange",85,47,b1,35),null(),HX_("date",2e,56,63,42)));
...
HX_DEFINE_DYNAMIC_FUNC1(Calendar_obj,set_date,return )
 ...
 ::Date Calendar_obj::get_selectedDate(){
            	HX_STACKFRAME(&_hx_pos_63f1e320bfcbb468_566_get_selectedDate)
HXLINE( 567)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 568)			return null();
            		}
HXLINE( 570)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toDate(this->behaviours->get(HX_("selectedDate",29,76,fd,d2)));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Calendar_obj,get_selectedDate,return )
 ...
 ::Date Calendar_obj::set_selectedDate( ::Date value){
            	HX_GC_STACKFRAME(&_hx_pos_63f1e320bfcbb468_613_set_selectedDate)
HXLINE( 614)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 615)			return value;
            		}
HXLINE( 617)		 ::haxe::ui::behaviours::Behaviours _hx_tmp = this->behaviours;
HXDLIN( 617)		_hx_tmp->set(HX_("selectedDate",29,76,fd,d2),::haxe::ui::util::_Variant::Variant_Impl__obj::fromDate(value));
HXLINE( 618)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("propertychange",85,47,b1,35),null(),HX_("selectedDate",29,76,fd,d2)));
HXLINE( 619)		return value;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Calendar_obj,set_selectedDate,return )
 ...
 ::haxe::ui::core::ComponentContainer Calendar_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_8c4be73b40ccdc64_651_cloneComponent)
HXLINE( 441)		 ::haxe::ui::components::Calendar c = ( ( ::haxe::ui::components::Calendar)(this->super::cloneComponent()) );
HXLINE( 450)		if (::hx::IsNotNull( this->get_date() )) {
HXLINE( 450)			c->set_date(this->get_date());
            		}
HXDLIN( 450)		if (::hx::IsNotNull( this->get_selectedDate() )) {
HXLINE( 450)			c->set_selectedDate(this->get_selectedDate());
            		}
HXLINE( 456)		{
...
HXLINE( 465)		return c;
 ...
 ::haxe::ui::core::ComponentContainer Calendar_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_63f1e320bfcbb468_493_self)
HXDLIN( 493)		return  ::haxe::ui::components::Calendar_obj::__alloc( HX_CTX );
            	}
