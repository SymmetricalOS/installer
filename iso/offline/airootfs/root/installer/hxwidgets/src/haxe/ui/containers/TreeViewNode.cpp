...
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_658_addNode,"haxe.ui.containers.TreeViewNode","addNode",0x88407904,"haxe.ui.containers.TreeViewNode.addNode","haxe/ui/macros/Macros.hx",658,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_658_removeNode,"haxe.ui.containers.TreeViewNode","removeNode",0x652a76c5,"haxe.ui.containers.TreeViewNode.removeNode","haxe/ui/macros/Macros.hx",658,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_650_clearNodes,"haxe.ui.containers.TreeViewNode","clearNodes",0x13ca29c3,"haxe.ui.containers.TreeViewNode.clearNodes","haxe/ui/macros/Macros.hx",650,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_661_getNodesInternal,"haxe.ui.containers.TreeViewNode","getNodesInternal",0xd31e61b7,"haxe.ui.containers.TreeViewNode.getNodesInternal","haxe/ui/macros/Macros.hx",661,0x27866361)
...
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_193_registerComposite,"haxe.ui.containers.TreeViewNode","registerComposite",0xc5a14ca5,"haxe.ui.containers.TreeViewNode.registerComposite","haxe/ui/macros/Macros.hx",193,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_522_registerBehaviours,"haxe.ui.containers.TreeViewNode","registerBehaviours",0xaa80d138,"haxe.ui.containers.TreeViewNode.registerBehaviours","haxe/ui/macros/Macros.hx",522,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_566_get_expanded,"haxe.ui.containers.TreeViewNode","get_expanded",0xf6628d61,"haxe.ui.containers.TreeViewNode.get_expanded","haxe/ui/macros/Macros.hx",566,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_613_set_expanded,"haxe.ui.containers.TreeViewNode","set_expanded",0x0b5bb0d5,"haxe.ui.containers.TreeViewNode.set_expanded","haxe/ui/macros/Macros.hx",613,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_3f1788001432f1e3_651_cloneComponent,"haxe.ui.containers.TreeViewNode","cloneComponent",0x95ea377f,"haxe.ui.containers.TreeViewNode.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",651,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_493_self,"haxe.ui.containers.TreeViewNode","self",0xb3959cab,"haxe.ui.containers.TreeViewNode.self","haxe/ui/macros/Macros.hx",493,0x27866361)
namespace haxe{
namespace ui{
...
bool TreeViewNode_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::containers::TreeViewNode TreeViewNode_obj::addNode( ::Dynamic data){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_658_addNode)
HXDLIN( 658)		return ( ( ::haxe::ui::containers::TreeViewNode)(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->behaviours->call(HX_("addNode",c3,4c,47,85),data))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(TreeViewNode_obj,addNode,return )
 ...
 ::haxe::ui::containers::TreeViewNode TreeViewNode_obj::removeNode( ::haxe::ui::containers::TreeViewNode node){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_658_removeNode)
HXDLIN( 658)		return ( ( ::haxe::ui::containers::TreeViewNode)(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->behaviours->call(HX_("removeNode",66,44,29,c6),node))) );
            	}
...
void TreeViewNode_obj::clearNodes(){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_650_clearNodes)
HXLINE( 651)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 652)			return;
            		}
HXLINE( 654)		this->behaviours->call(HX_("clearNodes",64,f7,c8,74),null());
            	}
...
::Array< ::Dynamic> TreeViewNode_obj::getNodesInternal(){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_661_getNodesInternal)
HXLINE( 662)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 663)			return null();
            		}
HXLINE( 665)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toArray(this->behaviours->call(HX_("getNodesInternal",18,9e,b4,dd),null()));
            	}
...
void TreeViewNode_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_193_registerComposite)
HXLINE( 194)		this->super::registerComposite();
HXLINE( 202)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::TreeViewNodeEvents >();
HXLINE( 206)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::TreeViewNodeBuilder >();
            	}


void TreeViewNode_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_522_registerBehaviours)
HXLINE( 523)		this->super::registerBehaviours();
HXLINE( 636)		 ::haxe::ui::behaviours::Behaviours _hx_tmp = this->behaviours;
HXDLIN( 636)		_hx_tmp->_hx_register(HX_("expanded",39,11,cf,f9),::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::Expanded >(),::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false));
HXLINE( 671)		this->behaviours->_hx_register(HX_("addNode",c3,4c,47,85),::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::AddNode >(),null());
HXDLIN( 671)		this->behaviours->_hx_register(HX_("removeNode",66,44,29,c6),::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::RemoveNode >(),null());
HXDLIN( 671)		this->behaviours->_hx_register(HX_("clearNodes",64,f7,c8,74),::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::ClearNodes >(),null());
HXDLIN( 671)		this->behaviours->_hx_register(HX_("getNodesInternal",18,9e,b4,dd),::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::GetNodesInternal >(),null());
            	}


bool TreeViewNode_obj::get_expanded(){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_566_get_expanded)
HXLINE( 567)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 568)			return false;
            		}
HXLINE( 570)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toBool(this->behaviours->get(HX_("expanded",39,11,cf,f9)));
            	}
...
bool TreeViewNode_obj::set_expanded(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_679ff0f9fead2ede_613_set_expanded)
...
HXDLIN( 617)		_hx_tmp->set(HX_("expanded",39,11,cf,f9),::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(value));
HXLINE( 618)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("propertychange",85,47,b1,35),null(),HX_("expanded",39,11,cf,f9)));
...
HX_DEFINE_DYNAMIC_FUNC1(TreeViewNode_obj,set_expanded,return )
 ...
 ::haxe::ui::core::ComponentContainer TreeViewNode_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_3f1788001432f1e3_651_cloneComponent)
HXLINE( 441)		 ::haxe::ui::containers::TreeViewNode c = ( ( ::haxe::ui::containers::TreeViewNode)(this->super::cloneComponent()) );
HXLINE( 456)		{
...
HXLINE( 465)		return c;
 ...
 ::haxe::ui::core::ComponentContainer TreeViewNode_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_679ff0f9fead2ede_493_self)
HXDLIN( 493)		return  ::haxe::ui::containers::TreeViewNode_obj::__alloc( HX_CTX );
            	}
