...
HX_DEFINE_STACK_FRAME(_hx_pos_aca048d79c8b6d12_249_new,"haxe.ui.components._TextField.HtmlTextBehaviour","new",0xcac2fb3d,"haxe.ui.components._TextField.HtmlTextBehaviour.new","haxe/ui/components/TextField.hx",249,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_aca048d79c8b6d12_250_validateData,"haxe.ui.components._TextField.HtmlTextBehaviour","validateData",0xbe086763,"haxe.ui.components._TextField.HtmlTextBehaviour.validateData","haxe/ui/components/TextField.hx",250,0x9dfe9498)
namespace haxe{
namespace ui{
...
void HtmlTextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_aca048d79c8b6d12_249_new)
...
void HtmlTextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_aca048d79c8b6d12_250_validateData)
HXLINE( 251)		 ::haxe::ui::components::TextField textfield = ::hx::TCast<  ::haxe::ui::components::TextField >::cast(this->_component);
HXLINE( 252)		::haxe::ui::components::_TextField::TextFieldHelper_obj::validateHtmlText(textfield,::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
...
HXLINE( 255)			this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(textfield->getTextInput()->get_htmlText());
            		}
            	}
