...
HX_DEFINE_STACK_FRAME(_hx_pos_8cb14cd8617c91e4_126_new,"haxe.ui.components._DropDown.SelectedIndexBehaviour","new",0xe7862c1c,"haxe.ui.components._DropDown.SelectedIndexBehaviour.new","haxe/ui/components/DropDown.hx",126,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_8cb14cd8617c91e4_127_validateData,"haxe.ui.components._DropDown.SelectedIndexBehaviour","validateData",0xe83da2a4,"haxe.ui.components._DropDown.SelectedIndexBehaviour.validateData","haxe/ui/components/DropDown.hx",127,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_8cb14cd8617c91e4_132_get,"haxe.ui.components._DropDown.SelectedIndexBehaviour","get",0xe780dc52,"haxe.ui.components._DropDown.SelectedIndexBehaviour.get","haxe/ui/components/DropDown.hx",132,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_8cb14cd8617c91e4_140_set,"haxe.ui.components._DropDown.SelectedIndexBehaviour","set",0xe789f75e,"haxe.ui.components._DropDown.SelectedIndexBehaviour.set","haxe/ui/components/DropDown.hx",140,0x145b8c86)
namespace haxe{
namespace ui{
...
void SelectedIndexBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_8cb14cd8617c91e4_126_new)
HXDLIN( 126)		super::__construct(component);
            	}
...
void SelectedIndexBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_8cb14cd8617c91e4_127_validateData)
HXLINE( 128)		::Dynamic handler = ::hx::TCast<  ::haxe::ui::components::DropDownBuilder >::cast(this->_component->_compositeBuilder)->get_handler();
HXLINE( 129)		::haxe::ui::components::IDropDownHandler_obj::set_selectedIndex(handler,::haxe::ui::util::_Variant::Variant_Impl__obj::toInt(this->_value));
            	}


 ::haxe::ui::util::VariantType SelectedIndexBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_8cb14cd8617c91e4_132_get)
HXLINE( 133)		if ((this->_component->get_isReady() == false)) {
HXLINE( 134)			return this->super::get();
            		}
...
HXLINE( 137)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(::haxe::ui::components::IDropDownHandler_obj::get_selectedIndex(handler));
            	}


void SelectedIndexBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_8cb14cd8617c91e4_140_set)
HXLINE( 141)		if ((this->_component->get_isReady() == false)) {
HXLINE( 142)			this->super::set(value);
HXLINE( 143)			return;
            		}
HXLINE( 145)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->get())) {
HXLINE( 146)			return;
            		}
HXLINE( 148)		this->_value = value;
HXLINE( 149)		this->invalidateData();
HXLINE( 150)		::Dynamic handler = ::hx::TCast<  ::haxe::ui::components::DropDownBuilder >::cast(this->_component->_compositeBuilder)->get_handler();
HXLINE( 151)		::haxe::ui::components::IDropDownHandler_obj::set_selectedIndex(handler,::haxe::ui::util::_Variant::Variant_Impl__obj::toInt(this->_value));
            	}
