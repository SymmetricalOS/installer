...
HXLINE( 760)			this->_inertia->__SetField(HX_("timestamp",d6,d4,ce,a5), ::__time_stamp(),::hx::paccDynamic);
            		}
...
HXLINE( 860)			Float now =  ::__time_stamp();
...
HXLINE( 882)			this->_inertia->__SetField(HX_("timestamp",d6,d4,ce,a5), ::__time_stamp(),::hx::paccDynamic);
...
HXLINE( 889)				Float _hx_tmp3 = this->_scrollview->get_hscrollPos();
HXDLIN( 889)				( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->x = ( (Float)(::Math_obj::round((_hx_tmp3 - ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("amplitude",43,15,fb,69),::hx::paccDynamic)) )->x))) );
            			}
            			else {
HXLINE( 891)				Float _hx_tmp4 = this->_scrollview->get_hscrollPos();
HXDLIN( 891)				( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->x = ( (Float)(::Math_obj::round((_hx_tmp4 + ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("amplitude",43,15,fb,69),::hx::paccDynamic)) )->x))) );
            			}
...
HXLINE( 899)				Float _hx_tmp5 = this->_scrollview->get_vscrollPos();
HXDLIN( 899)				( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->y = ( (Float)(::Math_obj::round((_hx_tmp5 - ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("amplitude",43,15,fb,69),::hx::paccDynamic)) )->y))) );
            			}
            			else {
HXLINE( 901)				Float _hx_tmp6 = this->_scrollview->get_vscrollPos();
HXDLIN( 901)				( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->y = ( (Float)(::Math_obj::round((_hx_tmp6 + ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("amplitude",43,15,fb,69),::hx::paccDynamic)) )->y))) );
            			}
HXLINE( 904)			bool _hx_tmp7;
HXDLIN( 904)			Float _hx_tmp8 = this->_scrollview->get_hscrollPos();
HXDLIN( 904)			if ((_hx_tmp8 == ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->x)) {
HXLINE( 904)				Float _hx_tmp9 = this->_scrollview->get_vscrollPos();
HXDLIN( 904)				_hx_tmp7 = (_hx_tmp9 == ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->y);
            			}
            			else {
HXLINE( 904)				_hx_tmp7 = false;
            			}
HXDLIN( 904)			if (_hx_tmp7) {
...
HXLINE( 910)			Float _hx_tmp10 = this->_scrollview->get_hscrollPos();
HXDLIN( 910)			if ((_hx_tmp10 == ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->x)) {
HXLINE( 911)				( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("amplitude",43,15,fb,69),::hx::paccDynamic)) )->x = ( (Float)(0) );
            			}
HXLINE( 913)			Float _hx_tmp11 = this->_scrollview->get_vscrollPos();
HXDLIN( 913)			if ((_hx_tmp11 == ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->y)) {
...
HXLINE( 926)		Float elapsed =  ::__time_stamp();
