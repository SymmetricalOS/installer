...
HX_DEFINE_STACK_FRAME(_hx_pos_7e34453dc2a6150d_294_new,"haxe.ui.components._TextField.SelectionStartIndexBehaviour","new",0xbe30dead,"haxe.ui.components._TextField.SelectionStartIndexBehaviour.new","haxe/ui/components/TextField.hx",294,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_7e34453dc2a6150d_296_get,"haxe.ui.components._TextField.SelectionStartIndexBehaviour","get",0xbe2b8ee3,"haxe.ui.components._TextField.SelectionStartIndexBehaviour.get","haxe/ui/components/TextField.hx",296,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_7e34453dc2a6150d_298_set,"haxe.ui.components._TextField.SelectionStartIndexBehaviour","set",0xbe34a9ef,"haxe.ui.components._TextField.SelectionStartIndexBehaviour.set","haxe/ui/components/TextField.hx",298,0x9dfe9498)
namespace haxe{
namespace ui{
...
void SelectionStartIndexBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_7e34453dc2a6150d_294_new)
HXDLIN( 294)		super::__construct(component);
            	}
...
bool SelectionStartIndexBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType SelectionStartIndexBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_7e34453dc2a6150d_296_get)
HXDLIN( 296)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(this->_component->getTextInput()->get_selectionStartIndex());
            	}


void SelectionStartIndexBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_7e34453dc2a6150d_298_set)
HXLINE( 299)		this->super::set(value);
HXLINE( 300)		this->_component->syncComponentValidation(null());
HXLINE( 301)		 ::haxe::ui::core::TextInput _hx_tmp = this->_component->getTextInput();
HXDLIN( 301)		_hx_tmp->set_selectionStartIndex(( (int)(::haxe::ui::util::_Variant::Variant_Impl__obj::toInt(value)) ));
            	}
