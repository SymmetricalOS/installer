...
HX_DEFINE_STACK_FRAME(_hx_pos_66d2f04623f2b71b_101_new,"haxe.ui.components._DropDown.DataSourceBehaviour","new",0x38df59a6,"haxe.ui.components._DropDown.DataSourceBehaviour.new","haxe/ui/components/DropDown.hx",101,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_66d2f04623f2b71b_102_get,"haxe.ui.components._DropDown.DataSourceBehaviour","get",0x38da09dc,"haxe.ui.components._DropDown.DataSourceBehaviour.get","haxe/ui/components/DropDown.hx",102,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_66d2f04623f2b71b_110_set,"haxe.ui.components._DropDown.DataSourceBehaviour","set",0x38e324e8,"haxe.ui.components._DropDown.DataSourceBehaviour.set","haxe/ui/components/DropDown.hx",110,0x145b8c86)
namespace haxe{
namespace ui{
...
void DataSourceBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_66d2f04623f2b71b_101_new)
...
bool DataSourceBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType DataSourceBehaviour_obj::get(){
            	HX_GC_STACKFRAME(&_hx_pos_66d2f04623f2b71b_102_get)
HXLINE( 103)		bool _hx_tmp;
HXDLIN( 103)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 103)			_hx_tmp = (::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value) == true);
            		}
            		else {
HXLINE( 103)			_hx_tmp = true;
            		}
HXDLIN( 103)		if (_hx_tmp) {
HXLINE( 104)			this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromDataSource( ::haxe::ui::data::ArrayDataSource_obj::__alloc( HX_CTX ,null()));
            		}
HXLINE( 107)		return this->_value;
            	}


void DataSourceBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_66d2f04623f2b71b_110_set)
HXLINE( 111)		this->super::set(value);
HXLINE( 112)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->_value)) {
HXLINE( 113)			return;
            		}
HXLINE( 116)		::Dynamic handler = ::hx::TCast<  ::haxe::ui::components::DropDownBuilder >::cast(this->_component->_compositeBuilder)->get_handler();
HXLINE( 117)		::haxe::ui::components::IDropDownHandler_obj::reset(handler);
HXLINE( 118)		bool _hx_tmp;
HXDLIN( 118)		if (::hx::IsNull( this->_component->get_text() )) {
HXLINE( 118)			_hx_tmp = this->_component->get_isReady();
            		}
            		else {
HXLINE( 118)			_hx_tmp = false;
            		}
HXDLIN( 118)		if (_hx_tmp) {
HXLINE( 119)			::hx::TCast<  ::haxe::ui::components::DropDown >::cast(this->_component)->set_selectedIndex(0);
            		}
            	}
