...
HX_DEFINE_STACK_FRAME(_hx_pos_bae50982b9dbaef1_261_new,"haxe.ui.components._TextField.IconBehaviour","new",0x4c9203dc,"haxe.ui.components._TextField.IconBehaviour.new","haxe/ui/components/TextField.hx",261,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_bae50982b9dbaef1_262_validateData,"haxe.ui.components._TextField.IconBehaviour","validateData",0xcc58d2e4,"haxe.ui.components._TextField.IconBehaviour.validateData","haxe/ui/components/TextField.hx",262,0x9dfe9498)
namespace haxe{
namespace ui{
...
void IconBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_bae50982b9dbaef1_261_new)
...
void IconBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_bae50982b9dbaef1_262_validateData)
HXLINE( 263)		 ::haxe::ui::components::TextField textfield = ::hx::TCast<  ::haxe::ui::components::TextField >::cast(this->_component);
HXLINE( 264)		 ::haxe::ui::components::Image icon = textfield->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Image >(),false,null()).StaticCast<  ::haxe::ui::components::Image >();
HXLINE( 265)		bool _hx_tmp;
HXDLIN( 265)		bool _hx_tmp1;
HXDLIN( 265)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 265)			_hx_tmp1 = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
...
HXLINE( 266)			textfield->removeComponent(icon,null(),null());
            		}
            		else {
HXLINE( 268)			if (::hx::IsNull( icon )) {
HXLINE( 269)				icon =  ::haxe::ui::components::Image_obj::__alloc( HX_CTX );
HXLINE( 270)				icon->set_id(HX_("textfield-icon",19,52,0f,5b));
HXLINE( 271)				icon->addClass(HX_("icon",79,e7,b2,45),null(),null());
HXLINE( 272)				icon->set_scriptAccess(false);
HXLINE( 273)				textfield->addComponentAt(icon,0);
            			}
HXLINE( 275)			icon->set_resource(::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value)));
            		}
            	}
