...
HX_DEFINE_STACK_FRAME(_hx_pos_07fae1d7d21df2d6_118_new,"haxe.ui.components._Range.RangeStart","new",0x5d31ec41,"haxe.ui.components._Range.RangeStart.new","haxe/ui/components/Range.hx",118,0x313cba28)
HX_LOCAL_STACK_FRAME(_hx_pos_07fae1d7d21df2d6_119_validateData,"haxe.ui.components._Range.RangeStart","validateData",0x89dd35df,"haxe.ui.components._Range.RangeStart.validateData","haxe/ui/components/Range.hx",119,0x313cba28)
namespace haxe{
namespace ui{
...
void RangeStart_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_07fae1d7d21df2d6_118_new)
HXDLIN( 118)		super::__construct(component);
            	}
...
void RangeStart_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_07fae1d7d21df2d6_119_validateData)
HXLINE( 120)		 ::haxe::ui::components::Range range = ::hx::TCast<  ::haxe::ui::components::Range >::cast(this->_component);
HXLINE( 121)		bool _hx_tmp;
HXDLIN( 121)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 121)			 ::haxe::ui::util::VariantType _hx_tmp1 = this->_value;
HXDLIN( 121)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::lt(_hx_tmp1,::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(( (Float)(range->get_min()) )));
            		}
            		else {
HXLINE( 121)			_hx_tmp = false;
            		}
HXDLIN( 121)		if (_hx_tmp) {
HXLINE( 122)			this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(( (Float)(range->get_min()) ));
            		}
            		else {
HXLINE( 123)			bool _hx_tmp2;
HXDLIN( 123)			if (::hx::IsNotNull( this->_value )) {
HXLINE( 123)				 ::haxe::ui::util::VariantType _hx_tmp3 = this->_value;
HXDLIN( 123)				_hx_tmp2 = ::haxe::ui::util::_Variant::Variant_Impl__obj::gt(_hx_tmp3,::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(( (Float)(range->get_max()) )));
            			}
            			else {
HXLINE( 123)				_hx_tmp2 = false;
            			}
HXDLIN( 123)			if (_hx_tmp2) {
HXLINE( 124)				this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(( (Float)(range->get_max()) ));
            			}
            		}
HXLINE( 126)		range->set_start(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value));
HXLINE( 127)		{
HXLINE( 127)			 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 127)			bool _hx_tmp4;
HXDLIN( 127)			if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 127)				_hx_tmp4 = (_this->_layoutLocked == true);
            			}
            			else {
HXLINE( 127)				_hx_tmp4 = true;
            			}
HXDLIN( 127)			if (!(_hx_tmp4)) {
HXLINE( 127)				_this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            			}
            		}
HXLINE( 129)		 ::haxe::ui::events::UIEvent changeEvent =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null());
HXLINE( 130)		changeEvent->previousValue = this->_previousValue;
HXLINE( 131)		changeEvent->value = this->_value;
HXLINE( 132)		this->_component->dispatch(changeEvent);
            	}
