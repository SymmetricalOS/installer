...
HX_DEFINE_STACK_FRAME(_hx_pos_9a3e1f2e5546618e_157_new,"haxe.ui.components._DropDown.SelectedItemBehaviour","new",0x59e78c9d,"haxe.ui.components._DropDown.SelectedItemBehaviour.new","haxe/ui/components/DropDown.hx",157,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_9a3e1f2e5546618e_158_validateData,"haxe.ui.components._DropDown.SelectedItemBehaviour","validateData",0x7436aa03,"haxe.ui.components._DropDown.SelectedItemBehaviour.validateData","haxe/ui/components/DropDown.hx",158,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_9a3e1f2e5546618e_163_getDynamic,"haxe.ui.components._DropDown.SelectedItemBehaviour","getDynamic",0x81181aec,"haxe.ui.components._DropDown.SelectedItemBehaviour.getDynamic","haxe/ui/components/DropDown.hx",163,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_9a3e1f2e5546618e_171_setDynamic,"haxe.ui.components._DropDown.SelectedItemBehaviour","setDynamic",0x8495b960,"haxe.ui.components._DropDown.SelectedItemBehaviour.setDynamic","haxe/ui/components/DropDown.hx",171,0x145b8c86)
namespace haxe{
namespace ui{
...
void SelectedItemBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_9a3e1f2e5546618e_157_new)
...
void SelectedItemBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_9a3e1f2e5546618e_158_validateData)
HXLINE( 159)		::Dynamic handler = ::hx::TCast<  ::haxe::ui::components::DropDownBuilder >::cast(this->_component->_compositeBuilder)->get_handler();
HXLINE( 160)		::haxe::ui::components::IDropDownHandler_obj::set_selectedItem(handler,this->_value);
            	}


 ::Dynamic SelectedItemBehaviour_obj::getDynamic(){
            	HX_STACKFRAME(&_hx_pos_9a3e1f2e5546618e_163_getDynamic)
HXLINE( 164)		if ((this->_component->get_isReady() == false)) {
HXLINE( 165)			return this->_value;
            		}
HXLINE( 167)		::Dynamic handler = ::hx::TCast<  ::haxe::ui::components::DropDownBuilder >::cast(this->_component->_compositeBuilder)->get_handler();
HXLINE( 168)		return ::haxe::ui::components::IDropDownHandler_obj::get_selectedItem(handler);
            	}


void SelectedItemBehaviour_obj::setDynamic( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_9a3e1f2e5546618e_171_setDynamic)
HXLINE( 172)		if ((this->_component->get_isReady() == false)) {
HXLINE( 173)			this->super::setDynamic(value);
HXLINE( 174)			return;
            		}
HXLINE( 177)		this->_value = value;
HXLINE( 178)		this->invalidateData();
...
HXLINE( 180)		::haxe::ui::components::IDropDownHandler_obj::set_selectedItem(handler,value);
            	}
