...
HX_DEFINE_STACK_FRAME(_hx_pos_089aa371adabd435_830_new,"haxe.ui.containers._TableView.SelectionModeBehaviour","new",0xe2b31930,"haxe.ui.containers._TableView.SelectionModeBehaviour.new","haxe/ui/containers/TableView.hx",830,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_089aa371adabd435_831_validateData,"haxe.ui.containers._TableView.SelectionModeBehaviour","validateData",0x1e5c7310,"haxe.ui.containers._TableView.SelectionModeBehaviour.validateData","haxe/ui/containers/TableView.hx",831,0x8a42a716)
namespace haxe{
namespace ui{
...
void SelectionModeBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_089aa371adabd435_830_new)
...
void SelectionModeBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_089aa371adabd435_831_validateData)
HXLINE( 832)		 ::haxe::ui::containers::TableView tableView = ::hx::TCast<  ::haxe::ui::containers::TableView >::cast(this->_component);
HXLINE( 833)		::Array< int > selectedIndices = tableView->get_selectedIndices();
HXLINE( 834)		if ((selectedIndices->length == 0)) {
HXLINE( 835)			return;
            		}
HXLINE( 838)		::String selectionMode = ( (::String)(this->_value) );
HXLINE( 839)		::String _hx_switch_0 = selectionMode;
            		if (  (_hx_switch_0==HX_("disabled",7c,41,04,7c)) ){
HXLINE( 841)			tableView->set_selectedIndices(null());
HXDLIN( 841)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==HX_("one-item",9a,d3,eb,3b)) ){
HXLINE( 844)			if ((selectedIndices->length > 1)) {
HXLINE( 845)				tableView->set_selectedIndices(::Array_obj< int >::__new(1)->init(0,selectedIndices->__get(0)));
            			}
