...
HX_DEFINE_STACK_FRAME(_hx_pos_05813c5e51712331_415_new,"haxe.ui.components._TextField.Events","new",0xcc68a265,"haxe.ui.components._TextField.Events.new","haxe/ui/components/TextField.hx",415,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_05813c5e51712331_420_register,"haxe.ui.components._TextField.Events","register",0xad9a623e,"haxe.ui.components._TextField.Events.register","haxe/ui/components/TextField.hx",420,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_05813c5e51712331_424_register,"haxe.ui.components._TextField.Events","register",0xad9a623e,"haxe.ui.components._TextField.Events.register","haxe/ui/components/TextField.hx",424,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_05813c5e51712331_437_unregister,"haxe.ui.components._TextField.Events","unregister",0x74693657,"haxe.ui.components._TextField.Events.unregister","haxe/ui/components/TextField.hx",437,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_05813c5e51712331_447_onMouseDown,"haxe.ui.components._TextField.Events","onMouseDown",0x37f3730d,"haxe.ui.components._TextField.Events.onMouseDown","haxe/ui/components/TextField.hx",447,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_05813c5e51712331_450_onFocusChange,"haxe.ui.components._TextField.Events","onFocusChange",0x92cf5ece,"haxe.ui.components._TextField.Events.onFocusChange","haxe/ui/components/TextField.hx",450,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_05813c5e51712331_460_onKeyUp,"haxe.ui.components._TextField.Events","onKeyUp",0xe22310c0,"haxe.ui.components._TextField.Events.onKeyUp","haxe/ui/components/TextField.hx",460,0x9dfe9498)
namespace haxe{
namespace ui{
...
void Events_obj::__construct( ::haxe::ui::components::TextField textfield){
            	HX_STACKFRAME(&_hx_pos_05813c5e51712331_415_new)
HXLINE( 416)		super::__construct(textfield);
HXLINE( 417)		this->_textfield = textfield;
            	}
...
void Events_obj::_hx_register(){
            	HX_STACKFRAME(&_hx_pos_05813c5e51712331_420_register)
HXDLIN( 420)		 ::haxe::ui::components::_TextField::Events _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 421)		if (::hx::IsNull( this->_textfield->getTextInput()->get_data()->onChangedCallback )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::haxe::ui::components::_TextField::Events,_gthis) HXARGC(0)
            			void _hx_run(){
            				HX_GC_STACKFRAME(&_hx_pos_05813c5e51712331_424_register)
HXLINE( 424)				if (((_gthis->_textfield->classes->indexOf(HX_(":empty",13,28,8d,a0),null()) != -1) == false)) {
HXLINE( 425)					 ::haxe::ui::components::TextField _gthis1 = _gthis->_textfield;
HXDLIN( 425)					_gthis1->set_text(_gthis->_textfield->getTextInput()->get_text());
HXLINE( 426)					 ::haxe::ui::components::TextField _gthis2 = _gthis->_textfield;
HXDLIN( 426)					_gthis2->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null()));
            				}
            			}
            			HX_END_LOCAL_FUNC0((void))

HXLINE( 422)			this->_textfield->getTextInput()->set_multiline(false);
HXLINE( 423)			this->_textfield->getTextInput()->get_data()->onChangedCallback =  ::Dynamic(new _hx_Closure_0(_gthis));
            		}
HXLINE( 431)		this->registerEvent(HX_("mousedown",07,85,e9,03),this->onMouseDown_dyn(),null());
HXLINE( 432)		this->registerEvent(HX_("focusin",bd,61,83,41),this->onFocusChange_dyn(),null());
HXLINE( 433)		this->registerEvent(HX_("focusout",b6,b7,76,11),this->onFocusChange_dyn(),null());
HXLINE( 434)		this->registerEvent(HX_("keyup",ba,d5,fe,de),this->onKeyUp_dyn(),null());
            	}


void Events_obj::unregister(){
            	HX_STACKFRAME(&_hx_pos_05813c5e51712331_437_unregister)
HXLINE( 438)		this->_textfield->getTextInput()->get_data()->onChangedCallback = null();
HXLINE( 439)		this->unregisterEvent(HX_("mousedown",07,85,e9,03),this->onMouseDown_dyn());
HXLINE( 440)		this->unregisterEvent(HX_("focusin",bd,61,83,41),this->onFocusChange_dyn());
HXLINE( 441)		this->unregisterEvent(HX_("focusout",b6,b7,76,11),this->onFocusChange_dyn());
HXLINE( 442)		this->unregisterEvent(HX_("keyup",ba,d5,fe,de),this->onKeyUp_dyn());
            	}


void Events_obj::onMouseDown( ::haxe::ui::events::MouseEvent event){
            	HX_STACKFRAME(&_hx_pos_05813c5e51712331_447_onMouseDown)
HXDLIN( 447)		this->_textfield->set_focus(true);
            	}
...
void Events_obj::onFocusChange( ::haxe::ui::events::FocusEvent event){
            	HX_STACKFRAME(&_hx_pos_05813c5e51712331_450_onFocusChange)
HXLINE( 451)		if ((this->_textfield->get_focus() == true)) {
HXLINE( 452)			this->_textfield->getTextInput()->focus();
            		}
            		else {
HXLINE( 454)			this->_textfield->getTextInput()->blur();
            		}
HXLINE( 456)		 ::haxe::ui::components::TextField _hx_tmp = this->_textfield;
HXDLIN( 456)		::haxe::ui::components::_TextField::TextFieldHelper_obj::validateText(_hx_tmp,this->_textfield->get_text());
            	}
...
void Events_obj::onKeyUp( ::haxe::ui::events::KeyboardEvent event){
            	HX_GC_STACKFRAME(&_hx_pos_05813c5e51712331_460_onKeyUp)
HXDLIN( 460)		int event1 = event->keyCode;
HXDLIN( 460)		if ((event1 == ::haxe::ui::core::Platform_obj::get_instance()->getKeyCode(HX_("enter",18,6d,86,70)))) {
HXLINE( 461)			event->cancel();
HXLINE( 462)			 ::haxe::ui::components::TextField _hx_tmp = this->_textfield;
HXDLIN( 462)			_hx_tmp->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("submit",18,58,06,9a),true,null()));
            		}
            	}
