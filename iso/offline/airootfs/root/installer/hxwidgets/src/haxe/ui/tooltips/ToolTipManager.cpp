...
HXLINE( 181)		 ::Dynamic w = this->_toolTip->get_width();
HXLINE( 182)		 ::Dynamic h = this->_toolTip->get_height();
...
HXLINE( 188)			x1 = (x1 - ( (Float)(w) ));
            		}
HXLINE( 190)		if (((y1 + h) > maxY)) {
HXLINE( 191)			Float y2 = (this->_lastMouseEvent->screenY - ( (Float)(h) ));
