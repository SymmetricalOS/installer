...
HX_DEFINE_STACK_FRAME(_hx_pos_177bb040d49f0b9e_128_new,"haxe.ui.components._CheckBox.SelectedBehaviour","new",0xcf0e0ca2,"haxe.ui.components._CheckBox.SelectedBehaviour.new","haxe/ui/components/CheckBox.hx",128,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_177bb040d49f0b9e_151_validateData,"haxe.ui.components._CheckBox.SelectedBehaviour","validateData",0x27b4815e,"haxe.ui.components._CheckBox.SelectedBehaviour.validateData","haxe/ui/components/CheckBox.hx",151,0xaeb3e5d4)
namespace haxe{
namespace ui{
...
void SelectedBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_177bb040d49f0b9e_128_new)
HXDLIN( 128)		super::__construct(component);
            	}
...
void SelectedBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_177bb040d49f0b9e_151_validateData)
HXLINE( 152)		 ::haxe::ui::components::CheckBoxValue valueComponent = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::CheckBoxValue >(),null(),null()).StaticCast<  ::haxe::ui::components::CheckBoxValue >();
HXLINE( 153)		if (::hx::IsNull( valueComponent )) {
HXLINE( 154)			return;
            		}
HXLINE( 157)		valueComponent->createIcon();
HXLINE( 159)		 ::haxe::ui::util::VariantType _hx_tmp = this->_value;
HXDLIN( 159)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp,::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(true))) {
HXLINE( 160)			valueComponent->addClass(HX_(":selected",95,f4,1e,7c),null(),null());
            		}
            		else {
HXLINE( 162)			valueComponent->removeClass(HX_(":selected",95,f4,1e,7c),null(),null());
            		}
HXLINE( 165)		 ::haxe::ui::events::UIEvent event =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null());
HXLINE( 166)		event->previousValue = this->_previousValue;
HXLINE( 167)		event->value = this->_value;
HXLINE( 168)		this->_component->dispatch(event);
            	}
