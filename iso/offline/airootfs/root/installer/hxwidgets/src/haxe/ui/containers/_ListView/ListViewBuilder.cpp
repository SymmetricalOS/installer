...
HXLINE( 382)				 ::Dynamic _hx_tmp1 = itemToEnsure->get_top();
HXDLIN( 382)				Float _hx_tmp2 = (_hx_tmp1 + itemToEnsure->get_height());
HXDLIN( 382)				if ((_hx_tmp2 > (vpos + contents->get_componentClipRect()->height))) {
HXLINE( 383)					 ::Dynamic _hx_tmp3 = itemToEnsure->get_top();
HXDLIN( 383)					Float _hx_tmp4 = (_hx_tmp3 + itemToEnsure->get_height());
HXDLIN( 383)					vscroll->set_pos((_hx_tmp4 - contents->get_componentClipRect()->height));
            				}
            				else {
