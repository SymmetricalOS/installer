...
HXLINE( 106)		 ::haxe::ui::core::Component c = this->_component->findComponent(HX_("menuitem-label",59,c2,dd,b5),::hx::ClassOf< ::haxe::ui::core::Component >(),null(),null()).StaticCast<  ::haxe::ui::core::Component >();
