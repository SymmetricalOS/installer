...
HXLINE(1157)			 ::Dynamic vcw = horizontalConstraint->get_width();
...
HXLINE(1185)			 ::Dynamic vch = verticalConstraint->get_height();
...
HXLINE(1220)		 ::Dynamic vcw = horizontalConstraint->get_width();
...
HXLINE(1261)		 ::Dynamic vch = verticalConstraint->get_height();
...
HXLINE(1317)		if (::hx::IsGreater( clipCX,this->_contents->get_width() )) {
HXLINE(1318)			 ::Dynamic clipCX1 = this->_contents->get_width();
...
HXLINE(1321)		if (::hx::IsGreater( clipCY,this->_contents->get_height() )) {
HXLINE(1322)			 ::Dynamic clipCY1 = this->_contents->get_height();
