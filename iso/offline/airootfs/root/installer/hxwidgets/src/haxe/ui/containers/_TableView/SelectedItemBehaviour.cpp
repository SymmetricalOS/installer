...
HX_DEFINE_STACK_FRAME(_hx_pos_92446cbdf73105b9_731_new,"haxe.ui.containers._TableView.SelectedItemBehaviour","new",0x286102f1,"haxe.ui.containers._TableView.SelectedItemBehaviour.new","haxe/ui/containers/TableView.hx",731,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_92446cbdf73105b9_732_getDynamic,"haxe.ui.containers._TableView.SelectedItemBehaviour","getDynamic",0x68e6d718,"haxe.ui.containers._TableView.SelectedItemBehaviour.getDynamic","haxe/ui/containers/TableView.hx",732,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_92446cbdf73105b9_738_set,"haxe.ui.containers._TableView.SelectedItemBehaviour","set",0x2864ce33,"haxe.ui.containers._TableView.SelectedItemBehaviour.set","haxe/ui/containers/TableView.hx",738,0x8a42a716)
namespace haxe{
namespace ui{
...
void SelectedItemBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_92446cbdf73105b9_731_new)
HXDLIN( 731)		super::__construct(component);
            	}
...
bool SelectedItemBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic SelectedItemBehaviour_obj::getDynamic(){
            	HX_STACKFRAME(&_hx_pos_92446cbdf73105b9_732_getDynamic)
HXLINE( 733)		 ::haxe::ui::containers::TableView tableView = ::hx::TCast<  ::haxe::ui::containers::TableView >::cast(this->_component);
HXLINE( 734)		::Array< int > selectedIndices = tableView->get_selectedIndices();
HXLINE( 735)		if ((selectedIndices->length > 0)) {
HXLINE( 735)			 ::haxe::ui::data::DataSource _hx_tmp = tableView->get_dataSource();
HXDLIN( 735)			return _hx_tmp->get(selectedIndices->__get((selectedIndices->length - 1)));
            		}
            		else {
HXLINE( 735)			return null();
            		}
HXDLIN( 735)		return null();
            	}


void SelectedItemBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_92446cbdf73105b9_738_set)
HXLINE( 739)		 ::haxe::ui::containers::TableView tableView = ::hx::TCast<  ::haxe::ui::containers::TableView >::cast(this->_component);
HXLINE( 740)		int index = tableView->get_dataSource()->indexOf(value);
HXLINE( 741)		bool _hx_tmp;
HXDLIN( 741)		if ((index != -1)) {
HXLINE( 741)			_hx_tmp = (tableView->get_selectedIndices()->indexOf(index,null()) == -1);
            		}
            		else {
HXLINE( 741)			_hx_tmp = false;
            		}
HXDLIN( 741)		if (_hx_tmp) {
HXLINE( 742)			tableView->set_selectedIndices(::Array_obj< int >::__new(1)->init(0,index));
            		}
            	}
