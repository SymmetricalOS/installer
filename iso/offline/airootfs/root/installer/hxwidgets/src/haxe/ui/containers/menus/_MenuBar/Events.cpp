...
HX_LOCAL_STACK_FRAME(_hx_pos_8e5f68d90f0657cf_212_hideCurrentMenu,"haxe.ui.containers.menus._MenuBar.Events","hideCurrentMenu",0x64c3db56,"haxe.ui.containers.menus._MenuBar.Events.hideCurrentMenu","haxe/ui/containers/menus/MenuBar.hx",212,0x144ebed0)
HX_LOCAL_STACK_FRAME(_hx_pos_8e5f68d90f0657cf_233_onMenuClose,"haxe.ui.containers.menus._MenuBar.Events","onMenuClose",0x1097eafa,"haxe.ui.containers.menus._MenuBar.Events.onMenuClose","haxe/ui/containers/menus/MenuBar.hx",233,0x144ebed0)
HX_LOCAL_STACK_FRAME(_hx_pos_8e5f68d90f0657cf_240_onMenuSelected,"haxe.ui.containers.menus._MenuBar.Events","onMenuSelected",0xa55e4c59,"haxe.ui.containers.menus._MenuBar.Events.onMenuSelected","haxe/ui/containers/menus/MenuBar.hx",240,0x144ebed0)
namespace haxe{
namespace ui{
...
HXLINE( 169)			menu->syncComponentValidation(null());
HXLINE( 171)			Float _hx_tmp1 = (left1 + menu->get_actualComponentWidth());
HXDLIN( 171)			if ((_hx_tmp1 > ::haxe::ui::core::Screen_obj::get_instance()->get_actualWidth())) {
HXLINE( 172)				Float left2 = target->get_screenLeft();
HXDLIN( 172)				Float left3 = (left2 - menu->get_actualComponentWidth());
HXDLIN( 172)				left1 = (left3 + target->get_actualComponentWidth());
HXLINE( 173)				rtl = true;
            			}
HXLINE( 176)			menu->set_left(left1);
HXLINE( 177)			menu->set_top((top3 - ::haxe::ui::Toolkit_obj::get_scaleY()));
            		}
HXLINE( 180)		this->_currentButton = target;
HXLINE( 181)		this->_currentMenu = menu;
HXLINE( 184)		if ((hasChildren1 == true)) {
HXLINE( 185)			 ::Dynamic cx = menu->get_width();
HXDLIN( 185)			Float cx1 = (( (Float)(cx) ) - ( (Float)(this->_currentButton->get_width()) ));
HXLINE( 186)			 ::haxe::ui::core::Component filler1 = menu->findComponent(HX_("menu-filler",de,29,53,58),null(),false,null()).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 187)			bool _hx_tmp2;
HXDLIN( 187)			if ((cx1 > 0)) {
HXLINE( 187)				_hx_tmp2 = ::hx::IsNotNull( filler1 );
            			}
            			else {
HXLINE( 187)				_hx_tmp2 = false;
            			}
HXDLIN( 187)			if (_hx_tmp2) {
HXLINE( 188)				cx1 = (cx1 + 1);
HXLINE( 189)				filler1->set_width(cx1);
HXLINE( 190)				if ((rtl == false)) {
HXLINE( 191)					filler1->set_left((( (Float)(menu->get_width()) ) - cx1));
            				}
            			}
            			else {
HXLINE( 193)				if (::hx::IsNotNull( filler1 )) {
HXLINE( 194)					menu->removeComponent(filler1,null(),null());
            				}
            			}
HXLINE( 197)			if (!(this->_currentMenu->hasEvent(HX_("menuselected",fa,a6,03,90),this->onMenuSelected_dyn()))) {
HXLINE( 198)				this->_currentMenu->registerEvent(HX_("menuselected",fa,a6,03,90),this->onMenuSelected_dyn(),null());
            			}
            		}
HXLINE( 202)		if ((hasChildren1 == true)) {
HXLINE( 203)			 ::haxe::ui::containers::menus::Menu _hx_tmp3 = this->_currentMenu;
HXDLIN( 203)			_hx_tmp3->dispatch( ::haxe::ui::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("click",48,7c,5e,48)));
HXLINE( 204)			 ::haxe::ui::containers::menus::MenuEvent menuEvent =  ::haxe::ui::containers::menus::MenuEvent_obj::__alloc( HX_CTX ,HX_("menuopened",88,29,84,cf),null(),null());
HXLINE( 205)			menuEvent->menu = this->_currentMenu;
HXLINE( 206)			this->_currentMenu->dispatch(menuEvent);
HXLINE( 207)			this->dispatch(menuEvent);
            		}
            	}
...
void Events_obj::hideCurrentMenu(){
            	HX_GC_STACKFRAME(&_hx_pos_8e5f68d90f0657cf_212_hideCurrentMenu)
HXDLIN( 212)		if (::hx::IsNotNull( this->_currentMenu )) {
HXLINE( 213)			 ::haxe::ui::containers::menus::_MenuBar::Builder builder = ::hx::TCast<  ::haxe::ui::containers::menus::_MenuBar::Builder >::cast(this->_menubar->_compositeBuilder);
HXLINE( 214)			{
HXLINE( 214)				int _g = 0;
HXDLIN( 214)				::Array< ::Dynamic> _g1 = builder->_buttons;
HXDLIN( 214)				while((_g < _g1->length)){
HXLINE( 214)					 ::haxe::ui::components::Button button = _g1->__get(_g).StaticCast<  ::haxe::ui::components::Button >();
HXDLIN( 214)					_g = (_g + 1);
HXLINE( 215)					if ((button->classes->indexOf(HX_("menubar-button-no-children-active",8a,a2,63,97),null()) != -1)) {
HXLINE( 216)						button->swapClass(HX_("menubar-button-no-children",49,4a,88,b3),HX_("menubar-button-no-children-active",8a,a2,63,97),null(),null());
            					}
            				}
            			}
HXLINE( 220)			 ::haxe::ui::containers::menus::MenuEvent menuEvent =  ::haxe::ui::containers::menus::MenuEvent_obj::__alloc( HX_CTX ,HX_("menuclosed",8b,70,41,bc),null(),null());
HXLINE( 221)			menuEvent->menu = this->_currentMenu;
HXLINE( 222)			this->_currentMenu->dispatch(menuEvent);
HXLINE( 223)			this->dispatch(menuEvent);
HXLINE( 225)			this->_currentMenu->unregisterEvent(HX_("menuselected",fa,a6,03,90),this->onMenuSelected_dyn());
HXLINE( 226)			this->_currentMenu->hide();
HXLINE( 227)			this->_currentButton->set_selected(false);
HXLINE( 228)			this->_currentButton = null();
HXLINE( 229)			this->_currentMenu = null();
            		}
            	}
...
void Events_obj::onMenuClose( ::haxe::ui::events::UIEvent event){
            	HX_STACKFRAME(&_hx_pos_8e5f68d90f0657cf_233_onMenuClose)
HXLINE( 234)		 ::haxe::ui::containers::menus::Menu menu = ::hx::TCast<  ::haxe::ui::containers::menus::Menu >::cast(event->target);
HXLINE( 235)		if (::hx::IsInstanceEq( this->_currentMenu,menu )) {
HXLINE( 236)			this->hideCurrentMenu();
            		}
            	}
...
void Events_obj::onMenuSelected( ::haxe::ui::containers::menus::MenuEvent event){
            	HX_GC_STACKFRAME(&_hx_pos_8e5f68d90f0657cf_240_onMenuSelected)
HXLINE( 241)		 ::haxe::ui::containers::menus::MenuEvent newEvent =  ::haxe::ui::containers::menus::MenuEvent_obj::__alloc( HX_CTX ,HX_("menuselected",fa,a6,03,90),null(),null());
HXLINE( 242)		newEvent->menu = event->menu;
HXLINE( 243)		newEvent->menuItem = event->menuItem;
HXLINE( 244)		this->_menubar->dispatch(newEvent);
HXLINE( 245)		this->hideCurrentMenu();
            	}
