...
HX_DEFINE_STACK_FRAME(_hx_pos_2002ff8f6351fa3b_9_new,"haxe.ui.backend.hxwidgets.behaviours.ControlMin","new",0x1e8ac864,"haxe.ui.backend.hxwidgets.behaviours.ControlMin.new","haxe/ui/backend/hxwidgets/behaviours/ControlMin.hx",9,0x7a7b82cd)
HX_LOCAL_STACK_FRAME(_hx_pos_2002ff8f6351fa3b_10_validateData,"haxe.ui.backend.hxwidgets.behaviours.ControlMin","validateData",0x26b73d5c,"haxe.ui.backend.hxwidgets.behaviours.ControlMin.validateData","haxe/ui/backend/hxwidgets/behaviours/ControlMin.hx",10,0x7a7b82cd)
HX_LOCAL_STACK_FRAME(_hx_pos_2002ff8f6351fa3b_22_get,"haxe.ui.backend.hxwidgets.behaviours.ControlMin","get",0x1e85789a,"haxe.ui.backend.hxwidgets.behaviours.ControlMin.get","haxe/ui/backend/hxwidgets/behaviours/ControlMin.hx",22,0x7a7b82cd)
namespace haxe{
namespace ui{
namespace backend{
namespace hxwidgets{
...
void ControlMin_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_2002ff8f6351fa3b_9_new)
...
void ControlMin_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_2002ff8f6351fa3b_10_validateData)
...
HXDLIN(  16)			_hx_tmp->set_min(( (int)(::haxe::ui::util::_Variant::Variant_Impl__obj::toInt(this->_value)) ));
            		}
            		else {
HXLINE(  17)			if (::Std_obj::isOfType(this->_component->get_window(),::hx::ClassOf< ::hx::widgets::SpinCtrl >())) {
HXLINE(  18)				 ::hx::widgets::SpinCtrl _hx_tmp1 = ::hx::TCast<  ::hx::widgets::SpinCtrl >::cast(this->_component->get_window());
HXDLIN(  18)				_hx_tmp1->set_min(( (int)(::haxe::ui::util::_Variant::Variant_Impl__obj::toInt(this->_value)) ));
            			}
            		}
            	}
 ...
 ::haxe::ui::util::VariantType ControlMin_obj::get(){
            	HX_STACKFRAME(&_hx_pos_2002ff8f6351fa3b_22_get)
...
HXLINE(  26)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(::hx::TCast<  ::hx::widgets::Slider >::cast(this->_component->get_window())->get_min());
            	}
