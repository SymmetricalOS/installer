...
HX_DEFINE_STACK_FRAME(_hx_pos_646b3b3d2ba35bc9_186_new,"haxe.ui.components._DropDown.SearchFieldBehaviour","new",0xa8cf14c1,"haxe.ui.components._DropDown.SearchFieldBehaviour.new","haxe/ui/components/DropDown.hx",186,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_646b3b3d2ba35bc9_187_get,"haxe.ui.components._DropDown.SearchFieldBehaviour","get",0xa8c9c4f7,"haxe.ui.components._DropDown.SearchFieldBehaviour.get","haxe/ui/components/DropDown.hx",187,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_646b3b3d2ba35bc9_192_set,"haxe.ui.components._DropDown.SearchFieldBehaviour","set",0xa8d2e003,"haxe.ui.components._DropDown.SearchFieldBehaviour.set","haxe/ui/components/DropDown.hx",192,0x145b8c86)
namespace haxe{
namespace ui{
...
void SearchFieldBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_646b3b3d2ba35bc9_186_new)
...
bool SearchFieldBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType SearchFieldBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_646b3b3d2ba35bc9_187_get)
HXLINE( 188)		 ::haxe::ui::components::DropDownEvents events = ::hx::TCast<  ::haxe::ui::components::DropDownEvents >::cast(this->_component->_internalEvents);
HXLINE( 189)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(events->get_searchField());
            	}


void SearchFieldBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_646b3b3d2ba35bc9_192_set)
HXLINE( 193)		 ::haxe::ui::components::DropDownEvents events = ::hx::TCast<  ::haxe::ui::components::DropDownEvents >::cast(this->_component->_internalEvents);
HXLINE( 194)		events->set_searchField(( ( ::haxe::ui::components::TextField)(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(value)) ));
            	}
