...
HXLINE( 139)			 ::haxe::ui::containers::menus::MenuEvent event1 =  ::haxe::ui::containers::menus::MenuEvent_obj::__alloc( HX_CTX ,HX_("menuselected",fa,a6,03,90),null(),null());
HXLINE( 140)			event1->menu = this->_menu;
HXLINE( 141)			event1->menuItem = item;
HXLINE( 142)			this->findRootMenu()->dispatch(event1);
...
HXLINE( 189)			Float left3 = source->get_screenLeft();
HXDLIN( 189)			left2 = (left3 - subMenu->get_actualComponentWidth());
            		}
...
HXLINE( 302)			 ::haxe::ui::containers::menus::Menu _hx_tmp1 = this->_menu;
HXDLIN( 302)			_hx_tmp1->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("close",b8,17,63,48),null(),null()));
            		}
            	}
