...
HX_LOCAL_STACK_FRAME(_hx_pos_b7c6648d67aeb5a0_329_set_width,"haxe.ui.core.ComponentBounds","set_width",0xe7dd02b0,"haxe.ui.core.ComponentBounds.set_width","haxe/ui/core/ComponentBounds.hx",329,0xcd40c58a)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c6648d67aeb5a0_338_get_width,"haxe.ui.core.ComponentBounds","get_width",0x048c16a4,"haxe.ui.core.ComponentBounds.get_width","haxe/ui/core/ComponentBounds.hx",338,0xcd40c58a)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c6648d67aeb5a0_349_set_height,"haxe.ui.core.ComponentBounds","set_height",0xafd4cffd,"haxe.ui.core.ComponentBounds.set_height","haxe/ui/core/ComponentBounds.hx",349,0xcd40c58a)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c6648d67aeb5a0_358_get_height,"haxe.ui.core.ComponentBounds","get_height",0xac573189,"haxe.ui.core.ComponentBounds.get_height","haxe/ui/core/ComponentBounds.hx",358,0xcd40c58a)
...
HX_DEFINE_DYNAMIC_FUNC0(ComponentBounds_obj,restorePercentSizes,(void))
 ...
 ::Dynamic ComponentBounds_obj::set_width( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_b7c6648d67aeb5a0_329_set_width)
HXLINE( 330)		if (::hx::IsEq( this->_width,value )) {
HXLINE( 331)			return value;
            		}
HXLINE( 333)		this->_width = value;
HXLINE( 334)		this->set_componentWidth(value);
...
HX_DEFINE_DYNAMIC_FUNC1(ComponentBounds_obj,set_width,return )
 ...
 ::Dynamic ComponentBounds_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_b7c6648d67aeb5a0_338_get_width)
HXLINE( 339)		Float f = ( (Float)(this->get_componentWidth()) );
HXLINE( 340)		return f;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ComponentBounds_obj,get_width,return )
 ...
 ::Dynamic ComponentBounds_obj::set_height( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_b7c6648d67aeb5a0_349_set_height)
HXLINE( 350)		if (::hx::IsEq( this->_height,value )) {
HXLINE( 351)			return value;
            		}
HXLINE( 353)		this->_height = value;
HXLINE( 354)		this->set_componentHeight(value);
...
HX_DEFINE_DYNAMIC_FUNC1(ComponentBounds_obj,set_height,return )
 ...
 ::Dynamic ComponentBounds_obj::get_height(){
            	HX_STACKFRAME(&_hx_pos_b7c6648d67aeb5a0_358_get_height)
HXLINE( 359)		Float f = ( (Float)(this->get_componentHeight()) );
HXLINE( 360)		return f;
            	}
...
HXDLIN( 423)			if (!(::hx::IsLessEq( this->get_width(),0 ))) {
HXLINE( 423)				_hx_tmp = ::hx::IsLessEq( this->get_height(),0 );
            			}
            			else {
...
HXDLIN( 599)		if (::hx::IsEq( this->get_width(),0 )) {
HXLINE( 599)			_hx_tmp = ::hx::IsEq( this->get_height(),0 );
            		}
            		else {
...
HXLINE( 604)		Float w = ( (Float)(this->get_width()) );
HXLINE( 605)		Float h = ( (Float)(this->get_height()) );
