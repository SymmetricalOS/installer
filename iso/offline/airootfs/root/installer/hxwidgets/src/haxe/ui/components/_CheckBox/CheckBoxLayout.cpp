...
HX_DEFINE_STACK_FRAME(_hx_pos_f436fda044ebfe43_262_new,"haxe.ui.components._CheckBox.CheckBoxLayout","new",0x644d3991,"haxe.ui.components._CheckBox.CheckBoxLayout.new","haxe/ui/components/CheckBox.hx",262,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_f436fda044ebfe43_263_repositionChildren,"haxe.ui.components._CheckBox.CheckBoxLayout","repositionChildren",0x7a0396aa,"haxe.ui.components._CheckBox.CheckBoxLayout.repositionChildren","haxe/ui/components/CheckBox.hx",263,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_f436fda044ebfe43_273_calcAutoSize,"haxe.ui.components._CheckBox.CheckBoxLayout","calcAutoSize",0x2b91ea34,"haxe.ui.components._CheckBox.CheckBoxLayout.calcAutoSize","haxe/ui/components/CheckBox.hx",273,0xaeb3e5d4)
namespace haxe{
namespace ui{
...
void CheckBoxLayout_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f436fda044ebfe43_262_new)
...
void CheckBoxLayout_obj::repositionChildren(){
            	HX_STACKFRAME(&_hx_pos_f436fda044ebfe43_263_repositionChildren)
HXLINE( 264)		this->super::repositionChildren();
HXLINE( 266)		 ::haxe::ui::components::Image icon = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Image >(),true,null()).StaticCast<  ::haxe::ui::components::Image >();
HXLINE( 267)		if (::hx::IsNotNull( icon )) {
HXLINE( 268)			icon->set_left(::Math_obj::fround(( (Float)(icon->get_left()) )));
HXLINE( 269)			icon->set_top(::Math_obj::fround(( (Float)(icon->get_top()) )));
            		}
            	}


 ::haxe::ui::geom::Size CheckBoxLayout_obj::calcAutoSize(::Array< ::Dynamic> exclusions){
            	HX_STACKFRAME(&_hx_pos_f436fda044ebfe43_273_calcAutoSize)
HXLINE( 274)		 ::haxe::ui::geom::Size size = this->super::calcAutoSize(exclusions);
HXLINE( 275)		if ((this->_component->get_autoWidth() == false)) {
HXLINE( 276)			 ::haxe::ui::components::Label label = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Label >(),false,null()).StaticCast<  ::haxe::ui::components::Label >();
HXLINE( 277)			if (::hx::IsNotNull( label )) {
HXLINE( 278)				label->set_percentWidth(100);
            			}
            		}
HXLINE( 281)		return size;
            	}
