...
HX_LOCAL_STACK_FRAME(_hx_pos_38114a4bcde44c07_522_registerBehaviours,"haxe.ui.containers.CalendarView","registerBehaviours",0x7b6d8e3a,"haxe.ui.containers.CalendarView.registerBehaviours","haxe/ui/macros/Macros.hx",522,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_38114a4bcde44c07_566_get_selectedDate,"haxe.ui.containers.CalendarView","get_selectedDate",0x8e5a3ed3,"haxe.ui.containers.CalendarView.get_selectedDate","haxe/ui/macros/Macros.hx",566,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_38114a4bcde44c07_613_set_selectedDate,"haxe.ui.containers.CalendarView","set_selectedDate",0xe49c2c47,"haxe.ui.containers.CalendarView.set_selectedDate","haxe/ui/macros/Macros.hx",613,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_a802d8e4d93101c0_651_cloneComponent,"haxe.ui.containers.CalendarView","cloneComponent",0x2bafcb81,"haxe.ui.containers.CalendarView.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",651,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_38114a4bcde44c07_493_self,"haxe.ui.containers.CalendarView","self",0xf2d27a2d,"haxe.ui.containers.CalendarView.self","haxe/ui/macros/Macros.hx",493,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_38114a4bcde44c07_193_registerComposite,"haxe.ui.containers.CalendarView","registerComposite",0x2de2a5e3,"haxe.ui.containers.CalendarView.registerComposite","haxe/ui/macros/Macros.hx",193,0x27866361)
		...
		if (inClassId<=(int)0x715d6dae) {
			if (inClassId<=(int)0x6fddb0ef) {
				if (inClassId<=(int)0x4ba87886) {
					...
					return inClassId==(int)0x6fddb0ef;
				}
			} else {
...
void CalendarView_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_38114a4bcde44c07_522_registerBehaviours)
HXLINE( 523)		this->super::registerBehaviours();
HXLINE( 636)		 ::haxe::ui::behaviours::Behaviours _hx_tmp = this->behaviours;
HXDLIN( 636)		_hx_tmp->_hx_register(HX_("selectedDate",29,76,fd,d2),::hx::ClassOf< ::haxe::ui::containers::_CalendarView::SelectedDateBehaviour >(),::haxe::ui::util::_Variant::Variant_Impl__obj::fromDate(::Date_obj::now()));
            	}


 ::Date CalendarView_obj::get_selectedDate(){
            	HX_STACKFRAME(&_hx_pos_38114a4bcde44c07_566_get_selectedDate)
...
HX_DEFINE_DYNAMIC_FUNC0(CalendarView_obj,get_selectedDate,return )
 ...
 ::Date CalendarView_obj::set_selectedDate( ::Date value){
            	HX_GC_STACKFRAME(&_hx_pos_38114a4bcde44c07_613_set_selectedDate)
...
HX_DEFINE_DYNAMIC_FUNC1(CalendarView_obj,set_selectedDate,return )
 ...
 ::haxe::ui::core::ComponentContainer CalendarView_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_a802d8e4d93101c0_651_cloneComponent)
HXLINE( 441)		 ::haxe::ui::containers::CalendarView c = ( ( ::haxe::ui::containers::CalendarView)(this->super::cloneComponent()) );
HXLINE( 456)		{
...
HXLINE( 465)		return c;
 ...
 ::haxe::ui::core::ComponentContainer CalendarView_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_38114a4bcde44c07_493_self)
HXDLIN( 493)		return  ::haxe::ui::containers::CalendarView_obj::__alloc( HX_CTX );
            	}


void CalendarView_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_38114a4bcde44c07_193_registerComposite)
HXLINE( 194)		this->super::registerComposite();
HXLINE( 202)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::containers::_CalendarView::Events >();
HXLINE( 210)		this->_defaultLayoutClass = ::hx::ClassOf< ::haxe::ui::layouts::VerticalLayout >();
HXLINE( 206)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::_CalendarView::Builder >();
            	}
