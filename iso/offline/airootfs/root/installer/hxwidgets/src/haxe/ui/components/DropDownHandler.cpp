...
HX_DEFINE_STACK_FRAME(_hx_pos_5eb292b087d03656_231_new,"haxe.ui.components.DropDownHandler","new",0x62d87425,"haxe.ui.components.DropDownHandler.new","haxe/ui/components/DropDown.hx",231,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_5eb292b087d03656_240_get_component,"haxe.ui.components.DropDownHandler","get_component",0xc9aeb099,"haxe.ui.components.DropDownHandler.get_component","haxe/ui/components/DropDown.hx",240,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_5eb292b087d03656_243_prepare,"haxe.ui.components.DropDownHandler","prepare",0xeadffbcc,"haxe.ui.components.DropDownHandler.prepare","haxe/ui/components/DropDown.hx",243,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_5eb292b087d03656_246_reset,"haxe.ui.components.DropDownHandler","reset",0x6e9128d4,"haxe.ui.components.DropDownHandler.reset","haxe/ui/components/DropDown.hx",246,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_5eb292b087d03656_251_get_selectedIndex,"haxe.ui.components.DropDownHandler","get_selectedIndex",0xd8a45493,"haxe.ui.components.DropDownHandler.get_selectedIndex","haxe/ui/components/DropDown.hx",251,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_5eb292b087d03656_254_set_selectedIndex,"haxe.ui.components.DropDownHandler","set_selectedIndex",0xfc122c9f,"haxe.ui.components.DropDownHandler.set_selectedIndex","haxe/ui/components/DropDown.hx",254,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_5eb292b087d03656_259_get_selectedItem,"haxe.ui.components.DropDownHandler","get_selectedItem",0x616b76b2,"haxe.ui.components.DropDownHandler.get_selectedItem","haxe/ui/components/DropDown.hx",259,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_5eb292b087d03656_262_set_selectedItem,"haxe.ui.components.DropDownHandler","set_selectedItem",0xb7ad6426,"haxe.ui.components.DropDownHandler.set_selectedItem","haxe/ui/components/DropDown.hx",262,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_5eb292b087d03656_265_applyDefault,"haxe.ui.components.DropDownHandler","applyDefault",0x6bce608e,"haxe.ui.components.DropDownHandler.applyDefault","haxe/ui/components/DropDown.hx",265,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_5eb292b087d03656_270_pauseEvents,"haxe.ui.components.DropDownHandler","pauseEvents",0x1aa0a774,"haxe.ui.components.DropDownHandler.pauseEvents","haxe/ui/components/DropDown.hx",270,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_5eb292b087d03656_275_resumeEvents,"haxe.ui.components.DropDownHandler","resumeEvents",0x06d66841,"haxe.ui.components.DropDownHandler.resumeEvents","haxe/ui/components/DropDown.hx",275,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_5eb292b087d03656_273_resumeEvents,"haxe.ui.components.DropDownHandler","resumeEvents",0x06d66841,"haxe.ui.components.DropDownHandler.resumeEvents","haxe/ui/components/DropDown.hx",273,0x145b8c86)
namespace haxe{
namespace ui{
namespace components{

void DropDownHandler_obj::__construct( ::haxe::ui::components::DropDown dropdown){
            	HX_STACKFRAME(&_hx_pos_5eb292b087d03656_231_new)
HXLINE( 268)		this->eventsPaused = false;
HXLINE( 235)		this->_dropdown = dropdown;
            	}
...
void *DropDownHandler_obj::_hx_getInterface(int inHash) {
 ...
 ::haxe::ui::core::Component DropDownHandler_obj::get_component(){
            	HX_STACKFRAME(&_hx_pos_5eb292b087d03656_240_get_component)
...
void DropDownHandler_obj::prepare( ::haxe::ui::containers::Box wrapper){
            	HX_STACKFRAME(&_hx_pos_5eb292b087d03656_243_prepare)
            	}
...
void DropDownHandler_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_5eb292b087d03656_246_reset)
            	}
...
int DropDownHandler_obj::get_selectedIndex(){
            	HX_STACKFRAME(&_hx_pos_5eb292b087d03656_251_get_selectedIndex)
HXDLIN( 251)		return -1;
            	}
...
int DropDownHandler_obj::set_selectedIndex(int value){
            	HX_STACKFRAME(&_hx_pos_5eb292b087d03656_254_set_selectedIndex)
HXDLIN( 254)		return value;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(DropDownHandler_obj,set_selectedIndex,return )
 ...
 ::Dynamic DropDownHandler_obj::get_selectedItem(){
            	HX_STACKFRAME(&_hx_pos_5eb292b087d03656_259_get_selectedItem)
...
HX_DEFINE_DYNAMIC_FUNC0(DropDownHandler_obj,get_selectedItem,return )
 ...
 ::Dynamic DropDownHandler_obj::set_selectedItem( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_5eb292b087d03656_262_set_selectedItem)
HXDLIN( 262)		return value;
            	}
...
void DropDownHandler_obj::applyDefault(){
            	HX_STACKFRAME(&_hx_pos_5eb292b087d03656_265_applyDefault)
            	}
...
void DropDownHandler_obj::pauseEvents(){
            	HX_STACKFRAME(&_hx_pos_5eb292b087d03656_270_pauseEvents)
HXDLIN( 270)		this->eventsPaused = true;
            	}
...
void DropDownHandler_obj::resumeEvents(){
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_5eb292b087d03656_275_resumeEvents)
HXLINE( 275)			_gthis->eventsPaused = false;
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_STACKFRAME(&_hx_pos_5eb292b087d03656_273_resumeEvents)
HXDLIN( 273)		 ::haxe::ui::components::DropDownHandler _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 274)		::haxe::ui::Toolkit_obj::callLater( ::Dynamic(new _hx_Closure_0(_gthis)));
            	}
