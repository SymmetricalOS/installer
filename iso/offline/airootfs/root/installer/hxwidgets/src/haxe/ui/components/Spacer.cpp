...
HX_LOCAL_STACK_FRAME(_hx_pos_f5a54bb0734e13eb_523_registerBehaviours,"haxe.ui.components.Spacer","registerBehaviours",0xc78b40b5,"haxe.ui.components.Spacer.registerBehaviours","haxe/ui/macros/Macros.hx",523,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8b59af7b867b8ccb_651_cloneComponent,"haxe.ui.components.Spacer","cloneComponent",0x2d4de47c,"haxe.ui.components.Spacer.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",651,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_f5a54bb0734e13eb_493_self,"haxe.ui.components.Spacer","self",0x9b5a9b68,"haxe.ui.components.Spacer.self","haxe/ui/macros/Macros.hx",493,0x27866361)
namespace haxe{
namespace ui{
...
void Spacer_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_f5a54bb0734e13eb_523_registerBehaviours)
HXDLIN( 523)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer Spacer_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_8b59af7b867b8ccb_651_cloneComponent)
HXLINE( 441)		 ::haxe::ui::components::Spacer c = ( ( ::haxe::ui::components::Spacer)(this->super::cloneComponent()) );
HXLINE( 456)		{
...
HXLINE( 465)		return c;
 ...
 ::haxe::ui::core::ComponentContainer Spacer_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_f5a54bb0734e13eb_493_self)
HXDLIN( 493)		return  ::haxe::ui::components::Spacer_obj::__alloc( HX_CTX );
            	}
