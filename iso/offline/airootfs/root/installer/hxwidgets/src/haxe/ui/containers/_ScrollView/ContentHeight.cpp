...
HXLINE( 266)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(( (Float)(contents->get_height()) ));
            	}
...
HXLINE( 273)			contents->set_height(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(value));
            		}
            	}
