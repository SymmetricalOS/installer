...
HX_DEFINE_STACK_FRAME(_hx_pos_895b182e86905dba_64_new,"haxe.ui.components._OptionBox.SelectedBehaviour","new",0x6e1cba43,"haxe.ui.components._OptionBox.SelectedBehaviour.new","haxe/ui/components/OptionBox.hx",64,0x8f34a36f)
HX_LOCAL_STACK_FRAME(_hx_pos_895b182e86905dba_65_validateData,"haxe.ui.components._OptionBox.SelectedBehaviour","validateData",0x78bd979d,"haxe.ui.components._OptionBox.SelectedBehaviour.validateData","haxe/ui/components/OptionBox.hx",65,0x8f34a36f)
namespace haxe{
namespace ui{
...
void SelectedBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_895b182e86905dba_64_new)
...
void SelectedBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_895b182e86905dba_65_validateData)
HXLINE(  66)		 ::haxe::ui::components::OptionBox optionbox = ::hx::TCast<  ::haxe::ui::components::OptionBox >::cast(this->_component);
HXLINE(  67)		 ::haxe::ui::components::OptionBoxBuilder _hx_tmp = ::hx::TCast<  ::haxe::ui::components::OptionBoxBuilder >::cast(this->_component->_compositeBuilder);
HXDLIN(  67)		_hx_tmp->setSelection(optionbox,::haxe::ui::util::_Variant::Variant_Impl__obj::toBool(this->_value),null());
            	}
