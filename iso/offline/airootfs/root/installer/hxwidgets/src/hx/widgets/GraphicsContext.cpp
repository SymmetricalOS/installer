...
HXLINE(  17)			::cpp::Pointer<  wxGraphicsContext > _hx_tmp1 = ::cpp::Pointer_obj::fromRaw(wxGraphicsContext::Create(dc->_ref->rawCast()));
HXDLIN(  17)			this->_ref = _hx_tmp1->reinterpret();
            		}
            	}
...
HXLINE(  40)		 wxString str = wxString::FromUTF8(text.utf8_str());
