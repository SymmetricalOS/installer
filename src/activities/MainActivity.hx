...
class MainActivity extends FlxState {
	...
	override public function create() {
		...
		title = new FlxText(0, 0, 0, "Welcome to Symmetrical OS!").setFormat("opensans.ttf", 64, FlxColor.BLACK);
		title.y = FlxG.height / 32;
		title.screenCenter(X);
		add(title);

		button = new FlxText(0, 0, 0, "Begin").setFormat("opensans.ttf", 48, FlxColor.fromInt(0xFFED820E), CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
